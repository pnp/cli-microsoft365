...
class PlannerTaskListCommand extends GraphItemsListCommand<Task> {
  ...
  public get description(): string {
    return 'Lists the planner tasks in a bucket, plan, or tasks for the currently logged in user';
  }
  ...
  public defaultProperties(): string[] | undefined {
    return ['id', 'title', 'startDateTime', 'dueDateTime', 'completedDateTime', 'planId', 'bucketId'];
  }
