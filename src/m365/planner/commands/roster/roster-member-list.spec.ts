...
import command, { options } from './roster-member-list.js';
...
describe(commands.ROSTER_MEMBER_LIST, () => {
  ...
  it('passes validation with valid rosterId', () => {
  ...
  it('retrieves members from a roster', async () => {
    ...
    await command.action(logger, { options: commandOptionsSchema.parse({ rosterId: validRosterId, verbose: true }) });
