...
- [graph report teamsdeviceusageuserdetail](../cmd/teams/report/teams-report-deviceusageuserdetail.md) - gets information about Microsoft Teams device usage by user [#960](https://github.com/pnp/office365-cli/issues/960)
- [graph teams funsettings set](../cmd/teams/funsettings/teams-funsettings-set.md) - updates fun settings of a Microsoft Teams team [#817](https://github.com/pnp/office365-cli/issues/817)
...
- [graph teams set](../cmd/teams/team/teams-team-set.md) - updates settings of a Microsoft Teams team [#815](https://github.com/pnp/office365-cli/issues/815)
...
- [graph teams clone](../cmd/teams/team/teams-team-clone.md) - creates a clone of a Microsoft Teams team [#924](https://github.com/pnp/office365-cli/issues/924)
...
- [graph teams archive](../cmd/teams/team/teams-team-archive.md) - archives specified Microsoft Teams team [#899](https://github.com/pnp/office365-cli/issues/899)
- [graph teams channel get](../cmd/teams/channel/teams-channel-get.md) - gets information about the specific Microsoft Teams team channel [#808](https://github.com/pnp/office365-cli/issues/808)
- [graph teams messagingsettings set](../cmd/teams/messagingsettings/teams-messagingsettings-set.md) - updates messaging settings of a Microsoft Teams team [#820](https://github.com/pnp/office365-cli/issues/820)
- [graph teams remove](../cmd/teams/team/teams-team-remove.md) - removes the specified Microsoft Teams team [#813](https://github.com/pnp/office365-cli/issues/813)
- [graph teams unarchive](../cmd/teams/team/teams-team-unarchive.md) - restores an archived Microsoft Teams team [#900](https://github.com/pnp/office365-cli/issues/900)
...
- [graph teams add](../cmd/teams/team/teams-team-add.md) - adds a new Microsoft Teams team [#615](https://github.com/pnp/office365-cli/issues/615)
- [graph teams app uninstall](../cmd/teams/app/teams-app-uninstall.md) - uninstalls an app from a Microsoft Team team [#843](https://github.com/pnp/office365-cli/issues/843)
- [graph teams channel set](../cmd/teams/channel/teams-channel-set.md) - updates properties of the specified channel in the given Microsoft Teams team [#816](https://github.com/pnp/office365-cli/issues/816)
- [graph teams guestsettings set](../cmd/teams/guestsettings/teams-guestsettings-set.md) - updates guest settings of a Microsoft Teams team [#818](https://github.com/pnp/office365-cli/issues/818)
- [graph teams tab list](../cmd/teams/tab/teams-tab-list.md) - lists tabs in the specified Microsoft Teams channel [#849](https://github.com/pnp/office365-cli/issues/849)
...
- [graph teams app install](../cmd/teams/app/teams-app-install.md) - installs an app from the catalog to a Microsoft Teams team [#842](https://github.com/pnp/office365-cli/issues/842)
- [graph teams funsettings list](../cmd/teams/funsettings/teams-funsettings-list.md) - lists fun settings for the specified Microsoft Teams team [#809](https://github.com/pnp/office365-cli/issues/809)
- [graph teams guestsettings list](../cmd/teams/guestsettings/teams-guestsettings-list.md) - lists guests settings for a Microsoft Teams team [#810](https://github.com/pnp/office365-cli/issues/810)
- [graph teams membersettings list](../cmd/teams/membersettings/teams-membersettings-list.md) - lists member settings for a Microsoft Teams team [#811](https://github.com/pnp/office365-cli/issues/811)
- [graph teams membersettings set](../cmd/teams/membersettings/teams-membersettings-set.md) - updates member settings of a Microsoft Teams team [#819](https://github.com/pnp/office365-cli/issues/819)
- [graph teams messagingsettings list](../cmd/teams/messagingsettings/teams-messagingsettings-list.md) - lists messaging settings for a Microsoft Teams team [#812](https://github.com/pnp/office365-cli/issues/812)
...
- [graph teams app list](../cmd/teams/app/teams-app-list.md) - lists apps from the Microsoft Teams app catalog [#826](https://github.com/pnp/office365-cli/issues/826)
- [graph teams app publish](../cmd/teams/app/teams-app-publish.md) - publishes Teams app to the organization's app catalog [#824](https://github.com/pnp/office365-cli/issues/824)
- [graph teams app remove](../cmd/teams/app/teams-app-remove.md) - removes a Teams app from the organization's app catalog [#825](https://github.com/pnp/office365-cli/issues/825)
- [graph teams app update](../cmd/teams/app/teams-app-update.md) - updates Teams app in the organization's app catalog [#827](https://github.com/pnp/office365-cli/issues/827)
- [graph teams channel list](../cmd/teams/channel/teams-channel-list.md) - lists channels in the specified Microsoft Teams team [#586](https://github.com/pnp/office365-cli/issues/586)
...
- [graph teams message list](../cmd/teams/message/teams-message-list.md) - lists all messages from a channel in a Microsoft Teams team [#588](https://github.com/pnp/office365-cli/issues/588)
...
- [graph teams channel message get](../cmd/teams/message/teams-message-get.md) - retrieves a message from a channel in a Microsoft Teams team [#589](https://github.com/pnp/office365-cli/issues/589)
...
- [graph teams channel add](../cmd/teams/channel/teams-channel-add.md) - adds a channel to the specified Microsoft Teams team [#587](https://github.com/pnp/office365-cli/issues/587)
...
- [azmgmt flow run get](../cmd/flow/run/flow-run-get.md) - gets information about a specific run of the specified Microsoft Flow [#400](https://github.com/pnp/office365-cli/issues/400)
- [azmgmt flow run list](../cmd/flow/run/flow-run-list.md) - lists runs of the specified Microsoft Flow [#399](https://github.com/pnp/office365-cli/issues/399)
...
- [graph teams list](../cmd/teams/team/teams-team-list.md) - lists Microsoft Teams in the current tenant [#558](https://github.com/pnp/office365-cli/pull/558)
...
- [graph user sendmail](../cmd/outlook/outlook-sendmail.md) - sends e-mail on behalf of the current user [#328](https://github.com/pnp/office365-cli/issues/328)
...
- [azmgmt flow environment get](../cmd/flow/environment/flow-environment-get.md) - gets information about the specified Microsoft Flow environment [#380](https://github.com/pnp/office365-cli/issues/380)
- [azmgmt flow environment list](../cmd/flow/environment/flow-environment-list.md) - lists Microsoft Flow environments in the current tenant [#379](https://github.com/pnp/office365-cli/issues/379)
