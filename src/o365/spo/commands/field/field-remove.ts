...
class SpoFieldRemoveCommand extends SpoCommand {
  ...
  public get description(): string {
    return 'Removes the specified field';
  }
  ...
  Remarks:
    ...
    If the specified field not exists, you will get an
    ${chalk.grey('Invalid field name')} error.
        
  Examples:

    Remove the site column by id located in site ${chalk.grey('https://contoso.sharepoint.com/sites/contoso-sales')}
    ...
    Remove the list column by id located in site ${chalk.grey('https://contoso.sharepoint.com/sites/contoso-sales')}. Retrieves the list by its title
    ...
    Remove the list column by display name located in site ${chalk.grey('https://contoso.sharepoint.com/sites/contoso-sales')}. Retrieves the list by its url
