...
class SpoCustomActionAddCommand extends SpoCommand {
   ...
   * more easly be used in validation or descriptions.
   */
    ...
    log(
      `  ${chalk.yellow('Important:')} before using this command, connect to a SharePoint Online site,
        ...
        Examples:
          ...
          Adds tenant wide SharePoint Framework Application Customizer extention in site or site collection ${chalk.grey('https://contoso.sharepoint.com/sites/test')}
          ...
          Adds tenant wide SharePoint Framework ${chalk.blue('modern List View')} Command Set extention in site or site collection ${chalk.grey('https://contoso.sharepoint.com/sites/test')}
          ...
          Creates url custom action in the SiteActions menu in site or site collection ${chalk.grey('https://contoso.sharepoint.com/sites/test')}
          ...
          Creates custom action in ${chalk.blue('classic')} Document Library edit context menu in site or site collection ${chalk.grey('https://contoso.sharepoint.com/sites/test')}
          ...
          Creates ScriptLink custom action with script source in ${chalk.blue('classic pages')} in site or site collection ${chalk.grey('https://contoso.sharepoint.com/sites/test')}
          ...
          Creates ScriptLink custom action with script block in ${chalk.blue('classic pages')} in site or site collection ${chalk.grey('https://contoso.sharepoint.com/sites/test')}
          ...
          Creates ${chalk.blue('classic List View')} custom action located in the Ribbon in site or site collection ${chalk.grey('https://contoso.sharepoint.com/sites/test')}
          ...
          Creates custom action with delegated rights in the SiteActions menu in site or site collection ${chalk.grey('https://contoso.sharepoint.com/sites/test')}
            ...
            Please note the --rights option accepts case sensitive values.
        
        Windows Command Shell note:
  
          Running this command from the Windows Command Shell (cmd.exe) or PowerShell for Windows OS XP, 7, 8, 8.1 without bash installed
          might require additional formatting for command options that have json, xml or javascript values because the command shell treat quotes differently.
