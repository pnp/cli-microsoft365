...
class AadLoginCommand extends Command {
  ...
  public commandHelp(args: CommandArgs, log: (help: string) => void): void {
    ...
    When logging in to the AAD Graph using a certificate, the Office 365 CLI
    ...
    To log in to the AAD Graph using a certificate, you will typically create
    a custom Azure AD application. To use this application
