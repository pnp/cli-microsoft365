...
class PaPcfInitCommand extends Command {
  ...
  public get description(): string {
    return 'Initializes a directory with a new PowerApps component framework project';
  }
  ...
  Examples:
    ...
    Initialize the PowerApps Component Framework for a ${chalk.grey('Field')} component, using ${chalk.grey('yourCustomFieldComponent')} as name and ${chalk.grey('yourNamespace')} as namespace
      ${commands.PCF_INIT} --namespace yourNamespace --name yourCustomFieldComponent --template Field

    Initialize the PowerApps Component Framework for a ${chalk.grey('Dataset')} component, using ${chalk.grey('yourCustomDatasetComponent')} as name and ${chalk.grey('yourNamespace')} as namespace
