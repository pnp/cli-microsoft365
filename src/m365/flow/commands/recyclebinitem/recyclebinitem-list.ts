...
class FlowRecycleBinItemListCommand extends PowerAutomateCommand {
  ...
  public async commandAction(logger: Logger, args: CommandArgs): Promise<void> {
    try {
      ...
      const flows = await odata.getAllItems<any>(`${PowerAutomateCommand.resource}/providers/Microsoft.ProcessSimple/scopes/admin/environments/${formatting.encodeQueryParameter(args.options.environmentName)}/v2/flows?api-version=2016-11-01&include=softDeletedFlows`);
