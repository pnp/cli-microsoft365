...
```sh
m365 spo homesite set --siteUrl https://contoso.sharepoint.com/sites/contosoportal --audienceIds "978b5280-4f80-47ea-a1db-b0d1d2fb1ba4,21af775d-17b3-4637-94a4-2ba8625277cb"
```

Set the audience to using their display name

```sh
m365 spo homesite set --siteUrl https://contoso.sharepoint.com/sites/contosoportal --audienceNames "Marketing, IT department"
```

Clear the audience and set to draft 

```sh
m365 spo homesite set --siteUrl https://contoso.sharepoint.com/sites/contosoportal --audienceNames '' --draftMode true
```

Configure multiple options

```sh
m365 spo homesite set --siteUrl https://contoso.sharepoint.com/sites/contosoportal --audienceNames 'Marketing, IT department' --draftMode true --targetedLicenseType "everyone" --vivaConnectionsDefaultStart true
```
