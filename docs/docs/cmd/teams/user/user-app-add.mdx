...
Install an app by id from the catalog for the specified user.

```sh
m365 teams user app add --id 4440558e-8c73-4597-abc7-3644a64c4bce --userId 2609af39-7775-4f94-a3dc-0dd67657e900
```

Install an app by name from the catalog for the specified user.

```sh
m365 teams user app add --name HelloWorld --userId 2609af39-7775-4f94-a3dc-0dd67657e900
```
