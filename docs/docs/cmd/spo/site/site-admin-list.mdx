...
<Tabs>
  ...
  ```text
  Id  LoginName                                                                    Title            IsPrimaryAdmin  PrincipalTypeString
  --  ---------------------------------------------------------------------------  ---------------  --------------  -------------------
  15  c:0o.c|federateddirectoryclaimprovider|d8430798-5a00-00ba-83b0-dd7a032d549a  Members          false           SecurityGroup
  6   i:0#.f|membership|user@mknetpl.onmicrosoft.com                               User             true            User
  ```
