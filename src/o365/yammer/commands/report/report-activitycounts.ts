...
class YammerReportActivityCountsCommand extends PeriodBasedReport {
  ...
  public commandHelp(args: {}, log: (help: string) => void): void {
    ...
    Gets the trends on the amount of Yammer activity in your organization by how many messages were posted, read, and liked for
    the last week
    ...
    format
      ${commands.YAMMER_REPORT_ACTIVITYCOUNTS} --period D7 --output text --outputFile "activitycounts.txt"

    Gets the trends on the amount of Yammer activity in your organization by how many messages were posted, read, and liked for
    the last week and exports the report data in the specified path in json
    format
      ${commands.YAMMER_REPORT_ACTIVITYCOUNTS} --period D7 --output json --outputFile "activitycounts.json"
`);
  }
}
