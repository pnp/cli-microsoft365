...
This command will permanently delete the Outlook message. To move a message to the trash bin, use [outlook message move](https://pnp.github.io/cli-microsoft365/cmd/outlook/message/message-move) instead.
