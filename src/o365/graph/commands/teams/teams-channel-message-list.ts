...
class GraphTeamsChannelMessageListCommand extends GraphItemsListCommand<any> {
  public get name(): string {
    return `${commands.TEAMS_CHANNEL_MESSAGE_LIST}`;
  }

  public get description(): string {
    return 'Lists all the messages from a channel in a Microsoft Teams team';
  }

  public commandAction(cmd: CommandInstance, args: CommandArgs, cb: () => void): void {
    let endpoint: string = `${auth.service.resource}/beta/teams/${args.options.teamId}/channels/${args.options.channelId}/messages`;
...
module.exports = new GraphTeamsChannelMessageListCommand();