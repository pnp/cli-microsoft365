...
export default [
  new FN001001_DEP_microsoft_sp_core_library('1.21.0-rc.0'),
  new FN001002_DEP_microsoft_sp_lodash_subset('1.21.0-rc.0'),
  new FN001003_DEP_microsoft_sp_office_ui_fabric_core('1.21.0-rc.0'),
  new FN001004_DEP_microsoft_sp_webpart_base('1.21.0-rc.0'),
  new FN001011_DEP_microsoft_sp_dialog('1.21.0-rc.0'),
  new FN001012_DEP_microsoft_sp_application_base('1.21.0-rc.0'),
  new FN001014_DEP_microsoft_sp_listview_extensibility('1.21.0-rc.0'),
  new FN001021_DEP_microsoft_sp_property_pane('1.21.0-rc.0'),
  new FN001023_DEP_microsoft_sp_component_base('1.21.0-rc.0'),
  new FN001024_DEP_microsoft_sp_diagnostics('1.21.0-rc.0'),
  new FN001025_DEP_microsoft_sp_dynamic_data('1.21.0-rc.0'),
  new FN001026_DEP_microsoft_sp_extension_base('1.21.0-rc.0'),
  new FN001027_DEP_microsoft_sp_http('1.21.0-rc.0'),
  new FN001028_DEP_microsoft_sp_list_subscription('1.21.0-rc.0'),
  new FN001029_DEP_microsoft_sp_loader('1.21.0-rc.0'),
  new FN001030_DEP_microsoft_sp_module_interfaces('1.21.0-rc.0'),
  new FN001031_DEP_microsoft_sp_odata_types('1.21.0-rc.0'),
  new FN001032_DEP_microsoft_sp_page_context('1.21.0-rc.0'),
  new FN001013_DEP_microsoft_decorators('1.21.0-rc.0'),
  new FN001034_DEP_microsoft_sp_adaptive_card_extension_base('1.21.0-rc.0'),
  new FN002001_DEVDEP_microsoft_sp_build_web('1.21.0-rc.0'),
  new FN002002_DEVDEP_microsoft_sp_module_interfaces('1.21.0-rc.0'),
  new FN002024_DEVDEP_eslint('8.57.1'),
  new FN002022_DEVDEP_microsoft_eslint_plugin_spfx('1.21.0-rc.0'),
  new FN002023_DEVDEP_microsoft_eslint_config_spfx('1.21.0-rc.0'),
  new FN002026_DEVDEP_typescript('5.3.3'),
  new FN002029_DEVDEP_microsoft_rush_stack_compiler_5_3('0.1.0'),
  new FN010001_YORC_version('1.21.0-rc.0'),
