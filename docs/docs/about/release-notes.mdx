...
- replaced `recycle` option by `permanent` option and renamed `skipRecycleBin` option to `permanent` for `entra`, `spo`, and `spe` commands [#7110](https://github.com/pnp/cli-microsoft365/issues/7110)
