...
- fixed 'spo folder roleassignment add' command by removing incorrect breakroleinheritance functionality. Closes [#6555](https://github.com/pnp/cli-microsoft365/issues/6555)
