...
class SpoCustomActionSetCommand extends SpoCommand {
  ...
  Remarks:
    ...
    To update custom action, you have to first connect to a SharePoint Online site using the
    ...
    Note, specifing the scope option might speed up the execution of the command, but would not update the scope. If the scope has to be changed, then the existing custom action should be removed and new should be added with different scope.

  Examples:
    
    Updates tenant-wide SharePoint Framework Application Customizer extension properties in site
    ...
    Updates tenant-wide SharePoint Framework ${chalk.blue('modern list view')} Command Set extension properties and sequence in site
    ${chalk.grey('https://contoso.sharepoint.com/sites/test')}
    ...
    Updates url custom action in the SiteActions menu in site ${chalk.grey('https://contoso.sharepoint.com/sites/test')}
