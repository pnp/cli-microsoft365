...
const appUninstallCommand: Command = require('./app-uninstall');
...
describe(commands.APP_UNINSTALL, () => {
  ...
  it('has correct name', () => {
    assert.equal(appUninstallCommand.name.startsWith(commands.APP_UNINSTALL), true);
  });

  it('has a description', () => {
    assert.notEqual(appUninstallCommand.description, null);
  });

  it('calls telemetry', (done) => {
    cmdInstance.action = appUninstallCommand.action();
  ...
  it('supports verbose mode', () => {
    const options = (appUninstallCommand.options() as CommandOption[]);
  ...
  it('has help referring to the right command', () => {
    ...
    (appUninstallCommand.help() as CommandHelp)({}, helpLog);
  ...
  it('has help with examples', () => {
    ...
    (appUninstallCommand.help() as CommandHelp)({}, log);
