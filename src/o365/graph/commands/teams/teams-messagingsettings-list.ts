...
class GraphTeamsMessagingSettingsListCommand extends GraphCommand {
  ...
  public get description(): string {
    return 'Lists messaging settings for a Microsoft Team';
  }
    ...
    auth
      ...
      .then((): request.RequestPromise => {
        const requestOptions: any = {
          url: `${auth.service.resource}/v1.0/teams/${args.options.teamId}?$select=messagingSettings`,
  ...
  Remarks:
    ...
    To get messaging settings for a Microsoft Team, you have to first log in to
