...
describe(commands.APP_REMOVE, () => {
  ...
  it('removes app from the sitecollection app catalog', (done) => {
    ...
    command.action(logger, { options: { debug: false, appCatalogScope: 'sitecollection', id: 'b2307a39-e878-458b-bc90-03bc578531d6', appCatalogUrl: 'https://contoso.sharepoint.com', confirm: true } }, () => {
      let correctRequestIssued = false;
      requests.forEach(r => {
