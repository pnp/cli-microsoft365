...
class SpoReportSiteUsageDetailCommand extends DateAndPeriodBasedReport {
  ...
  Examples:
    ...
    Gets details about SharePoint site usage for
    May 1, 2019
      ${commands.REPORT_SITEUSAGEDETAIL} --date 2019-05-01

    Gets details about SharePoint site usage for the last week 
    and exports the report data in the specified path in text format
      ${commands.REPORT_SITEUSAGEDETAIL} --period D7 --output text --outputFile 'C:/report.txt'

    Gets details about SharePoint site usage for the last week
    and exports the report data in the specified path in json format
      ${commands.REPORT_SITEUSAGEDETAIL} --period D7 --output json --outputFile 'C:/report.json'
`);
  }
}
