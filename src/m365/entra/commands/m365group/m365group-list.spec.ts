...
describe(commands.M365GROUP_LIST, () => {
  ...
  it('include site URLs of Microsoft 365 Groups using includeSiteUrl parameter', async () => {
    sinon.stub(request, 'get').callsFake(async (opts) => {
      if (opts.url === `https://graph.microsoft.com/v1.0/groups?$filter=groupTypes/any(c:c+eq+'Unified')&$top=100`) {
        return {
          "value": [
  ...
  it('include site URLs of Microsoft 365 Groups using includeSiteUrl parameter (debug)', async () => {
    sinon.stub(request, 'get').callsFake(async (opts) => {
      if (opts.url === `https://graph.microsoft.com/v1.0/groups?$filter=groupTypes/any(c:c+eq+'Unified')&$top=100`) {
        return {
          "value": [
  ...
  it('include site URLs of Microsoft 365 Groups. one group without site using includeSiteUrl parameter', async () => {
    sinon.stub(request, 'get').callsFake(async (opts) => {
      if (opts.url === `https://graph.microsoft.com/v1.0/groups?$filter=groupTypes/any(c:c+eq+'Unified')&$top=100`) {
        return {
          "value": [
  ...
  it('handles error when retrieving Microsoft 365 Group url using includeSiteUrl parameter', async () => {
    sinon.stub(request, 'get').callsFake(async (opts) => {
      if (opts.url === `https://graph.microsoft.com/v1.0/groups?$filter=groupTypes/any(c:c+eq+'Unified')&$top=100`) {
        return {
          "value": [
