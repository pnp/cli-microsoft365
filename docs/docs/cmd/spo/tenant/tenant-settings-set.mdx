...
: Enables the preview for OneDrive and SharePoint integration with Microsoft Entra ID B2B. Allowed values `true`, `false`. Microsoft Entra ID one-time passcode needs to be enabled for this integration to work. For more information see [http://aka.ms/spo-b2b-integration](https://aka.ms/spo-b2b-integration).

`--SyncAadB2BManagementPolicy [SyncAadB2BManagementPolicy]`
: Syncs Azure B2B Management Policies. Allowed values `true`, `false`. For more information, see [SharePoint and OneDrive integration with Microsoft Entra ID B2B](https://aka.ms/spo-b2b-integration).
```
...
Enable Microsoft Entra ID B2B integration for SharePoint and OneDrive and sync the Microsoft Entra ID B2B management policies
...
Disable Microsoft Entra ID B2B integration for SharePoint and OneDrive
