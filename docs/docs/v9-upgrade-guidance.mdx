...
We have removed deprecated `Yammer` command aliases. These aliases were introduced in the previous version to prevent the introduction of breaking changes. The following aliases were removed:
