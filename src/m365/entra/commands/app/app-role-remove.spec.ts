...
describe(commands.APP_ROLE_REMOVE, () => {
  ...
  it('handles error when multiple apps with the specified appName found and --force option is specified', async () => {
    ...
    }), new CommandError(`Multiple Microsoft Entra application registration with name 'App-Name' found. Found: 5b31c38c-2584-42f0-aa47-657fb3a84230, a39c738c-939e-433b-930d-b02f2931a08b.`));
  });
