...
`aad o365group restore` | [aad m365group recyclebinitem restore](./cmd/aad/m365group/m365group-recyclebinitem-restore.mdx) | Renamed to better match intention and naming convention.
...
[aad o365group add](./cmd/aad/m365group/m365group-add.mdx)|`isPrivate [isPrivate]`|`isPrivate` (changed to flag)
[aad o365group recyclebinitem list](./cmd/aad/m365group/m365group-recyclebinitem-list.mdx)|`displayName`|`groupDisplayName`
[aad o365group recyclebinitem list](./cmd/aad/m365group/m365group-recyclebinitem-list.mdx)|`mailNickname`|`groupMailNickname`
[aad o365group teamify](./cmd/aad/m365group/m365group-teamify.mdx)|`groupId`|`id`
