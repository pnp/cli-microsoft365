...
describe(commands.RUN_GET, () => {
  ...
  it('retrieves information about the specified run (debug)', async () => {
    ...
    await command.action(logger, { options: { debug: true, flow: '396d5ec9-ae2d-4a84-967d-cd7f56cd8f30', environment: 'Default-48595cc3-adce-4267-8e99-0c838923dbb9', name: '08586653536760200319026785874CU62' } });
  ...
  it('retrieves information about the specified run', async () => {
    ...
    await command.action(logger, { options: { debug: false, flow: '396d5ec9-ae2d-4a84-967d-cd7f56cd8f30', environment: 'Default-48595cc3-adce-4267-8e99-0c838923dbb9', name: '08586653536760200319026785874CU62' } });
    assert(loggerLogSpy.calledWith({
      "name": "08586653536760200319026785874CU62",
      "id": "/providers/Microsoft.ProcessSimple/environments/Default-48595cc3-adce-4267-8e99-0c838923dbb9/flows/396d5ec9-ae2d-4a84-967d-cd7f56cd8f30/runs/08586653536760200319026785874CU62",
      "type": "Microsoft.ProcessSimple/environments/flows/runs",
  ...
  it('renders empty string for endTime, if the run specified is still running', async () => {
    ...
    await command.action(logger, { options: { debug: false, flow: 'edf73e7e-9928-4cb9-8eb2-fc263f375ada', environment: 'Default-48595cc3-adce-4267-8e99-0c838923dbb9', name: '08586652586741142222645090602CU35' } });
    assert(loggerLogSpy.calledWith({
      "name": "08586652586741142222645090602CU35",
      "id": "/providers/Microsoft.ProcessSimple/environments/Default-48595cc3-adce-4267-8e99-0c838923dbb9/flows/edf73e7e-9928-4cb9-8eb2-fc263f375ada/runs/08586652586741142222645090602CU35",
      "type": "Microsoft.ProcessSimple/environments/flows/runs",
  ...
  it('correctly handles environment not found', async () => {
    ...
    await assert.rejects(command.action(logger, { options: { debug: false, flow: '396d5ec9-ae2d-4a84-967d-cd7f56cd8f30', environment: 'Default-48595cc3-adce-4267-8e99-0c838923dbbx', name: '08586653536760200319026785874CU62' } } as any),
  ...
  it('correctly handles Flow not found', async () => {
    ...
    await assert.rejects(command.action(logger, { options: { debug: false, flow: '1c6ee23a-a835-44bc-a4f5-462b658efc12', environment: 'Default-48595cc3-adce-4267-8e99-0c838923dbb9', name: '08586653536760200319026785874CU62' } } as any),
  ...
  it('correctly handles run not found', async () => {
    ...
    await assert.rejects(command.action(logger, { options: { debug: false, flow: '396d5ec9-ae2d-4a84-967d-cd7f56cd8f30', environment: 'Default-48595cc3-adce-4267-8e99-0c838923dbb9', name: 'ABC' } } as any),
