    ...
    sinon.stub(request, 'get').callsFake((opts) => {
      ...
      if (opts.url === `https://graph.microsoft.com/v1.0/teams/00000000-0000-0000-0000-000000000000/channels?$filter=displayName eq 'Channel Name'`) {
        return Promise.resolve({
          ...
          "value": [
            {
              "id": "19:00000000000000000000000000000000%40thread.skype",
              "displayName": "Channel Name",
              "description": "Channel description",
              "email": "",
              "webUrl": "https://teams.microsoft.com/l/channel/19%3A00000000000000000000000000000000%40thread.skype/General?groupId=00000000-0000-0000-0000-000000000000&tenantId=00000000-0000-0000-0000-000000000000",
