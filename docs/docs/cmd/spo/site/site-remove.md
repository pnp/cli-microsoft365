...
If the site which you have selected to remove is Groupifieid (Modern Team Site), the parameters `fromRecycleBin` or `skipRecycleBin` or `wait` will not be applicable
