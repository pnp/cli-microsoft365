...
class GraphO365GroupListCommand extends GraphItemsListCommand<Group> {
  ...
  public getTelemetryProperties(args: CommandArgs): any {
    ...
    telemetryProps.orphan = args.options.orphan;
  ...
  public commandAction(cmd: CommandInstance, args: CommandArgs, cb: () => void): void {
    ...
    const expandOwners: string = args.options.orphan ? '&$expand=owners' : '';
  ...
  Remarks:
    ...
    Using the ${chalk.blue('--orphan')} option, you can retrieve Office 365 Groups without owners.
  ...
  Examples:
    ...
    List Office 365 Groups without owners in the tenant
      ${chalk.grey(config.delimiter)} ${this.name} --orphan
`);
  }
}
