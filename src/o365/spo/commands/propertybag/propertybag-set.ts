...
class SpoPropertyBagSetCommand extends SpoPropertyBagBaseCommand {
  ...
  public get description(): string {
    return 'Sets the value of the specified property. Adds the property if does not exist';
  }
  ...
  public commandAction(cmd: CommandInstance, args: CommandArgs, cb: () => void): void {
    ...
    auth
      ...
      .then((isNoScriptSite: boolean): Promise<IdentityResponse> => {
        ...
        if (isNoScriptSite) {
          return new Promise<IdentityResponse>((resolve, reject) => {
            return reject('Site has NoScript enabled, and setting property bag values is not supported');
          });
        }
  ...
  private isNoScriptSite(webIdentityResp: IdentityResponse, options: Options, cmd: CommandInstance): Promise<boolean> {
    ...
    return new Promise<boolean>((resolve, reject) => {
      ...
      .then((basePermissionsResp:BasePermissions) => {

        return resolve(basePermissionsResp.has(PermissionKind.AddAndCustomizePages) === false);
      })
    ...
    const options: CommandOption[] = [
      {
        ...
        description: 'The URL of the site from which the property should be set'
      },
      {
        option: '-k, --key <key>',
      ...
      },
      {
        ...
        description: 'Site-relative URL of the folder which the property should be set',
      }
    ];
  ...
  Examples:
    ...
    Sets the value of the ${chalk.grey('key1')} property located in site ${chalk.grey('https://contoso.sharepoint.com/sites/test')}
    ...
    Sets the value of the ${chalk.grey('key1')} property located in site root folder ${chalk.grey('https://contoso.sharepoint.com/sites/test')}
    ...
    Sets the value of the ${chalk.grey('key1')} property located in site document library ${chalk.grey('https://contoso.sharepoint.com/sites/test')}
    ...
    Sets the value of the ${chalk.grey('key1')} property located in folder in site document library ${chalk.grey('https://contoso.sharepoint.com/sites/test')}
    ...
    Sets the value of the ${chalk.grey('key1')} property located in site list ${chalk.grey('https://contoso.sharepoint.com/sites/test')}
