...
3. Script also will send an email to the configured user/s using the command [outlool mail send](https://pnp.github.io/cli-microsoft365/cmd/outlook/mail/mail-send/) so that concerned team could be notified
