...
class SpoSiteDesignRemoveCommand extends SpoCommand {
      ...
      auth
        ...
        .then((res: ContextInfo): request.RequestPromise => {
          ...
          const requestOptions: any = {
            url: `${auth.site.url}/_api/Microsoft.Sharepoint.Utilities.WebTemplateExtensions.SiteScriptUtility.DeleteSiteDesign`,
  ...
  Remarks:
    ...
    To remove a site design, you have to first connect to a SharePoint site using the ${chalk.blue(commands.CONNECT)} command,
