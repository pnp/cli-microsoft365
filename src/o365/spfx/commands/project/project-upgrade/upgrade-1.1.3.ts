...
import { FN011005_MAN_safeWithCustomScriptDisabled_propertyChange } from "./rules/FN011005_MAN_safeWithCustomScriptDisabled_propertyChange";

module.exports = [
  new FN002002_DEVDEP_microsoft_sp_module_interfaces('1.1.1'),
  new FN010001_YORC_version('1.1.3'),
  new FN011005_MAN_safeWithCustomScriptDisabled_propertyChange()
];