...
class OutlookMailboxUsageMailboxCountCommand extends PeriodBasedReport {
  ...
  public commandHelp(args: {}, log: (help: string) => void): void {
    ...
    and exports the report data in the specified path in text format
      ${commands.OUTLOOK_REPORT_MAILBOXUSAGEMAILBOXCOUNT} --period D7 --output text --outputFile 'C:/report.txt'

      Gets the total number of user mailboxes in your organization and how many are active each day for the last week
    and exports the report data in the specified path in json format
      ${commands.OUTLOOK_REPORT_MAILBOXUSAGEMAILBOXCOUNT} --period D7 --output json --outputFile 'C:/report.json'
`);
  }
}

module.exports = new OutlookMailboxUsageMailboxCountCommand();