...
Register CLI for Microsoft 365 or Microsoft Entra ID application as a management application for the Power Platform using m365 pp managementapp add [options]
