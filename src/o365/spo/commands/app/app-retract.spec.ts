...
const appRetractCommand: Command = require('./app-retract');
...
describe(commands.APP_RETRACT, () => {
  ...
  it('has correct name', () => {
    assert.equal(appRetractCommand.name.startsWith(commands.APP_RETRACT), true);
  });

  it('has a description', () => {
    assert.notEqual(appRetractCommand.description, null);
  });

  it('calls telemetry', (done) => {
    cmdInstance.action = appRetractCommand.action();
  ...
  it('supports verbose mode', () => {
    const options = (appRetractCommand.options() as CommandOption[]);
  ...
  it('has help referring to the right command', () => {
    ...
    (appRetractCommand.help() as CommandHelp)({}, helpLog);
  ...
  it('has help with examples', () => {
    ...
    (appRetractCommand.help() as CommandHelp)({}, log);
