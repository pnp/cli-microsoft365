...
: Sets disabled modern list templates Ids to hide when creating a new list. Array of GUIDs split by comma. Example: `c9b1909e-901a-0000-2cdb-e91c3f46320a,c9b1909e-901a-0000-2cdb-e91c3f463201`
...
: Enables or disables SharePoint auto news digest. Allowed values `true`, `false`.

`--AllowCommentsTextOnEmailEnabled [AllowCommentsTextOnEmailEnabled]`
: Allows showing surrounding document context in email notification when user mentioned in comments. Allowed values `true`, `false`.
...
: Specifies whether the policy which determines Restricted Access Control Policy is enabled. Allowed values `true`, `false`.
