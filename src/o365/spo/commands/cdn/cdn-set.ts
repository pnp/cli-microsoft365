...
class SpoCdnSetCommand extends SpoCommand {
  ...
  public commandAction(cmd: CommandInstance, args: CommandArgs, cb: (err?: any) => void): void {
    ...
    const noDefaultOrigins: number = args.options.noDefaultOrigins ? 1 : 0;
    ...
    auth
      ...
      .then((res: ContextInfo): request.RequestPromise => {
        ...
        if (cdnType === 2) {
          if (this.verbose) {
            cmd.log(`${(enabled ? 'Enabling' : 'Disabling')} Both (Privated and Public) CDN locations. Please wait, this might take a moment...`);
          }

          requestBody = `<Request AddExpandoFieldTypeSuffix="true" SchemaVersion="15.0.0.0" LibraryVersion="16.0.0.0" ApplicationName="${config.applicationName}" xmlns="http://schemas.microsoft.com/sharepoint/clientquery/2009"><Actions><ObjectPath Id="12" ObjectPathId="11" /><Method Name="SetTenantCdnEnabled" Id="13" ObjectPathId="11"><Parameters><Parameter Type="Enum">1</Parameter><Parameter Type="Boolean">${enabled}</Parameter></Parameters></Method><Method Name="SetTenantCdnEnabled" Id="14" ObjectPathId="11"><Parameters><Parameter Type="Enum">0</Parameter><Parameter Type="Boolean">${enabled}</Parameter></Parameters></Method><Method Name="CreateTenantCdnDefaultOrigins" Id="15" ObjectPathId="11"><Parameters><Parameter Type="Enum">${noDefaultOrigins}</Parameter></Parameters></Method><Method Name="CreateTenantCdnDefaultOrigins" Id="16" ObjectPathId="11"><Parameters><Parameter Type="Enum">${noDefaultOrigins}</Parameter></Parameters></Method></Actions><ObjectPaths><Constructor Id="11" TypeId="{268004ae-ef6b-4e9b-8425-127220d84719}" /></ObjectPaths></Request>`;
        }
        else {
          if (this.verbose) {
