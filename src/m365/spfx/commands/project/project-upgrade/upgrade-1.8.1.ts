...
export default [
  new FN001001_DEP_microsoft_sp_core_library({ packageVersion: '1.8.1' }),
  new FN001002_DEP_microsoft_sp_lodash_subset({ packageVersion: '1.8.1' }),
  new FN001003_DEP_microsoft_sp_office_ui_fabric_core({ packageVersion: '1.8.1' }),
  new FN001004_DEP_microsoft_sp_webpart_base({ packageVersion: '1.8.1' }),
  new FN001021_DEP_microsoft_sp_property_pane({ packageVersion: '1.8.1' }),
  new FN001011_DEP_microsoft_sp_dialog({ packageVersion: '1.8.1' }),
  new FN001012_DEP_microsoft_sp_application_base({ packageVersion: '1.8.1' }),
  new FN001013_DEP_microsoft_decorators({ packageVersion: '1.8.1' }),
  new FN001014_DEP_microsoft_sp_listview_extensibility({ packageVersion: '1.8.1' }),
  new FN001023_DEP_microsoft_sp_component_base({ packageVersion: '1.8.1' }),
  new FN001024_DEP_microsoft_sp_diagnostics({ packageVersion: '1.8.1' }),
  new FN001025_DEP_microsoft_sp_dynamic_data({ packageVersion: '1.8.1' }),
  new FN001026_DEP_microsoft_sp_extension_base({ packageVersion: '1.8.1' }),
  new FN001027_DEP_microsoft_sp_http({ packageVersion: '1.8.1' }),
  new FN001028_DEP_microsoft_sp_list_subscription({ packageVersion: '1.8.1' }),
  new FN001029_DEP_microsoft_sp_loader({ packageVersion: '1.8.1' }),
  new FN001030_DEP_microsoft_sp_module_interfaces({ packageVersion: '1.8.1' }),
  new FN001031_DEP_microsoft_sp_odata_types({ packageVersion: '1.8.1' }),
  new FN001032_DEP_microsoft_sp_page_context({ packageVersion: '1.8.1' }),
  new FN002001_DEVDEP_microsoft_sp_build_web({ packageVersion: '1.8.1' }),
