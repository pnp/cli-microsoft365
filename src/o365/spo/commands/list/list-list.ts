...
class ListListCommand extends SpoCommand {
  ...
  public get description(): string {
    return 'Lists all available list in the specified url';
  }
  ...
  public commandAction(cmd: CommandInstance, args: CommandArgs, cb: () => void): void {
    ...
    auth
      ...
      .then((res: ContextInfo): Promise<ListInstanceCollection> => {
        if (this.debug) {
          cmd.log('Response:');
          cmd.log(res);
          cmd.log('');
  ...
  Remarks:
    ...
    To get all lists, you have to first connect to SharePoint using the
