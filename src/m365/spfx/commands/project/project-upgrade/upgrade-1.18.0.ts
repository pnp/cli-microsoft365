...
export default [
  new FN001001_DEP_microsoft_sp_core_library({ packageVersion: '1.18.0' }),
  new FN001002_DEP_microsoft_sp_lodash_subset({ packageVersion: '1.18.0' }),
  new FN001003_DEP_microsoft_sp_office_ui_fabric_core({ packageVersion: '1.18.0' }),
  new FN001004_DEP_microsoft_sp_webpart_base({ packageVersion: '1.18.0' }),
  new FN001011_DEP_microsoft_sp_dialog({ packageVersion: '1.18.0' }),
  ...
  new FN001026_DEP_microsoft_sp_extension_base({ packageVersion: '1.18.0' }),
  new FN001027_DEP_microsoft_sp_http({ packageVersion: '1.18.0' }),
  new FN001028_DEP_microsoft_sp_list_subscription({ packageVersion: '1.18.0' }),
  new FN001029_DEP_microsoft_sp_loader({ packageVersion: '1.18.0' }),
  new FN001030_DEP_microsoft_sp_module_interfaces({ packageVersion: '1.18.0' }),
  new FN001031_DEP_microsoft_sp_odata_types({ packageVersion: '1.18.0' }),
  new FN001032_DEP_microsoft_sp_page_context({ packageVersion: '1.18.0' }),
  new FN001035_DEP_fluentui_react({ packageVersion: '8.106.4' }),
  new FN001013_DEP_microsoft_decorators({ packageVersion: '1.18.0' }),
  new FN001034_DEP_microsoft_sp_adaptive_card_extension_base({ packageVersion: '1.18.0' }),
  new FN002001_DEVDEP_microsoft_sp_build_web({ packageVersion: '1.18.0' }),
  new FN002002_DEVDEP_microsoft_sp_module_interfaces({ packageVersion: '1.18.0' }),
  new FN002019_DEVDEP_spfx_fast_serve_helpers({ packageVersion: '1.18.14' }),
  new FN002022_DEVDEP_microsoft_eslint_plugin_spfx({ packageVersion: '1.18.0' }),
  ...
  new FN012017_TSC_extends({ _extends: './node_modules/@microsoft/rush-stack-compiler-4.7/includes/tsconfig-web.json' }),
  new FN021003_PKG_engines_node({ version: '>=16.13.0 <17.0.0 || >=18.17.1 <19.0.0' })
];
