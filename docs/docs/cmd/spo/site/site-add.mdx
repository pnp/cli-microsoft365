...
Create modern team site and enable site collection app catalog
...
Create communication site and enable site collection app catalog
...
Create new classic site and enable site collection app catalog
