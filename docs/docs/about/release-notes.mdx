...
- enhanced 'spo list view add' with extra types [#6735](https://github.com/pnp/cli-microsoft365/issues/6735)
- updated `spo page section add` command with Flexible section [#6742](https://github.com/pnp/cli-microsoft365/issues/6742)
