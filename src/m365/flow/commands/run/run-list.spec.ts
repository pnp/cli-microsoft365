...
describe(commands.RUN_LIST, () => {
  ...
  it('retrieves runs for specific flow (debug)', (done) => {
    ...
    command.action(logger, { options: { debug: true, environmentName: 'Default-48595cc3-adce-4267-8e99-0c838923dbb9', flowName: "396d5ec9-ae2d-4a84-967d-cd7f56cd8f30" } }, () => {
      try {
  ...
  it('retrieves runs for specific flow', (done) => {
    ...
    command.action(logger, { options: { debug: false, environmentName: 'Default-48595cc3-adce-4267-8e99-0c838923dbb9', flowName: "396d5ec9-ae2d-4a84-967d-cd7f56cd8f30" } }, () => {
      try {
        assert(loggerLogSpy.calledWith([
          {
            "name": "08586653536760200319026785874CU62",
  ...
  it('correctly handles no environment found', (done) => {
    ...
    command.action(logger, { options: { debug: false, environmentName: 'Default-d87a7535-dd31-4437-bfe1-95340acd55c6', flowName: "396d5ec9-ae2d-4a84-967d-cd7f56cd8f30" } } as any, (err?: any) => {
      try {
  ...
  it('correctly handles no runs for this flow found', (done) => {
    ...
    command.action(logger, { options: { debug: false, environmentName: 'Default-48595cc3-adce-4267-8e99-0c838923dbb9', flowName: '16c90c26-25e0-4800-8af9-da594e02d427' } }, () => {
      try {
  ...
  it('correctly handles no runs for this flow found (debug)', (done) => {
    ...
    command.action(logger, { options: { debug: true, environmentName: 'Default-48595cc3-adce-4267-8e99-0c838923dbb9', flowName: '16c90c26-25e0-4800-8af9-da594e02d427' } }, () => {
      try {
