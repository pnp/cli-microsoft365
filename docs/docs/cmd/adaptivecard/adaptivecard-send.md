...
The command will return the result of the request to the URL. If the response is successful it will return the body of response. If the response is not a success, the command will return an error with the failed http status code.
