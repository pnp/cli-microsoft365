...
export default [
  new FN001001_DEP_microsoft_sp_core_library({ packageVersion: '1.23.0' }),
  new FN001002_DEP_microsoft_sp_lodash_subset({ packageVersion: '1.23.0' }),
  new FN001003_DEP_microsoft_sp_office_ui_fabric_core({ packageVersion: '1.23.0' }),
  new FN001004_DEP_microsoft_sp_webpart_base({ packageVersion: '1.23.0' }),
  new FN001011_DEP_microsoft_sp_dialog({ packageVersion: '1.23.0' }),
  new FN001012_DEP_microsoft_sp_application_base({ packageVersion: '1.23.0' }),
  new FN001014_DEP_microsoft_sp_listview_extensibility({ packageVersion: '1.23.0' }),
  new FN001021_DEP_microsoft_sp_property_pane({ packageVersion: '1.23.0' }),
  new FN001023_DEP_microsoft_sp_component_base({ packageVersion: '1.23.0' }),
  new FN001024_DEP_microsoft_sp_diagnostics({ packageVersion: '1.23.0' }),
  new FN001025_DEP_microsoft_sp_dynamic_data({ packageVersion: '1.23.0' }),
  new FN001026_DEP_microsoft_sp_extension_base({ packageVersion: '1.23.0' }),
  new FN001027_DEP_microsoft_sp_http({ packageVersion: '1.23.0' }),
  new FN001028_DEP_microsoft_sp_list_subscription({ packageVersion: '1.23.0' }),
  new FN001029_DEP_microsoft_sp_loader({ packageVersion: '1.23.0' }),
  new FN001030_DEP_microsoft_sp_module_interfaces({ packageVersion: '1.23.0' }),
  new FN001031_DEP_microsoft_sp_odata_types({ packageVersion: '1.23.0' }),
  new FN001032_DEP_microsoft_sp_page_context({ packageVersion: '1.23.0' }),
  new FN001013_DEP_microsoft_decorators({ packageVersion: '1.23.0' }),
  new FN001034_DEP_microsoft_sp_adaptive_card_extension_base({ packageVersion: '1.23.0' }),
  new FN002002_DEVDEP_microsoft_sp_module_interfaces({ packageVersion: '1.23.0' }),
  new FN002022_DEVDEP_microsoft_eslint_plugin_spfx({ packageVersion: '1.23.0' }),
  new FN002023_DEVDEP_microsoft_eslint_config_spfx({ packageVersion: '1.23.0' }),
  new FN002030_DEVDEP_microsoft_spfx_web_build_rig({ packageVersion: '1.23.0' }),
  new FN002034_DEVDEP_microsoft_spfx_heft_plugins({ packageVersion: '1.23.0' }),
  new FN010001_YORC_version({ version: '1.23.0' }),
  new FN002031_DEVDEP_rushstack_heft({ packageVersion: '1.2.17' }),
  new FN027001_OVERRIDES_rushstack_heft({ version: '1.2.17' }),
  new FN002025_DEVDEP_eslint_plugin_react_hooks({ packageVersion: '5.2.0' }),
  new FN002024_DEVDEP_eslint({ packageVersion: '9.37.0' }),
  new FN015016_FILE_eslint_config_js({ add: true, contents: `const spfxProfile = require('@microsoft/eslint-config-spfx/lib/flat-profiles/react');
