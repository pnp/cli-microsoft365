...
Updates list in the specified site
...
`-t|--title [title]`|Title of the list to update
`-i|--id [id]`|Id of the list to update
`-u|--webUrl <webUrl>`|URL of the site where the list should be updated
...
To update a list on a site, you have to first connect to a SharePoint Online site using the [spo connect](../connect.md) command, eg. `spo connect https://contoso.sharepoint.com`.

## Examples

Update a list with title _Announcements_ in site _https://contoso.sharepoint.com/sites/project-x_ and set allowContentTypes to _true_

```sh
spo list set --title Announcements --webUrl https://contoso.sharepoint.com/sites/project-x --allowContentTypes true
```

Update a list with title _Announcements_ in site _https://contoso.sharepoint.com/sites/project-x_ and set enableVersioning to _true_ and set number of Major versions to 50

```sh
spo list set --title Announcements --webUrl https://contoso.sharepoint.com/sites/project-x --enableVersioning true --majorVersionLimit 50
```

Update a list with id _3EA5A977-315E-4E25-8B0F-E4F949BF6B8F_ in site _https://contoso.sharepoint.com/sites/project-x_ with content types and versioning enabled and major version limit set to _50_ and Major minor versions to _100_
