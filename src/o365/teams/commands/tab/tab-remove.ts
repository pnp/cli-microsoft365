...
class TeamsTabRemoveCommand extends GraphItemsListCommand<Tab> {
      ...
      cmd.prompt(
        {
          ...
          name: "continue",
          default: false,
          message: `Are you sure you want to remove the tab with tab id ${args.options.tabId} from channel ${args.options.channelId} in team ${args.options.teamId}?`
        },
