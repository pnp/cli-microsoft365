...
describe(commands.LIST_GET, () => {
  ...
  it('retrieves and prints all details of list if title option is passed and retrieve version policies for a document library', async () => {
  ...
  it('retrieves and prints all details of list if title option is passed and does not retrieve version policies for a generic list', async () => {
    const webUrl = 'https://contoso.sharepoint.com';
