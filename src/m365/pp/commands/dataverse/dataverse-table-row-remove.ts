...
class PpDataverseTableRowRemoveCommand extends PowerPlatformCommand {
  ...
  public async commandAction(logger: Logger, args: any): Promise<void> {
    ...
    if (args.options.force) {
      ...
      const result = await Cli.promptForConfirmation(`Are you sure you want to remove row '${args.options.id}' from table '${args.options.tableName || args.options.entitySetName}'?`);
