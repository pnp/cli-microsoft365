...
- [spo site alert list](../cmd/spo/site/site-alert-list.mdx) - lists all SharePoint list alerts [#6861](https://github.com/pnp/cli-microsoft365/issues/6861)
- [spo site alert remove](../cmd/spo/site/site-alert-remove.mdx) - removes an alert from a SharePoint list [#6863](https://github.com/pnp/cli-microsoft365/issues/6863)
...
- migrated [entra license list](../cmd/entra/license-list.mdx) to Zod [#6905](https://github.com/pnp/cli-microsoft365/issues/6905)
