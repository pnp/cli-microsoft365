...
import { FN021008_PKG_scripts_eject_webpack } from './FN021008_PKG_scripts_eject_webpack.js';

describe('FN021008_PKG_scripts_eject_webpack', () => {
  let findings: Finding[];
  let rule: FN021008_PKG_scripts_eject_webpack;

  beforeEach(() => {
    findings = [];
    rule = new FN021008_PKG_scripts_eject_webpack({ version: 'heft eject-webpack' });
  });
