...
- added [spe container recyclebinitem remove](../cmd/spe/container/container-recyclebinitem-remove.mdx) command [#6734](https://github.com/pnp/cli-microsoft365/issues/6734)
