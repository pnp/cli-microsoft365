...
class SpoThemeApplyCommand extends SpoCommand {
  ...
  public options(): CommandOption[] {
    ...
    },
    {
      ...
      description: 'Set to specify if the supplied theme name is an out of the box theme'
    }];
