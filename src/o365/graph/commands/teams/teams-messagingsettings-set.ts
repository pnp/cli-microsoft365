...
class GraphTeamsMessageSettingsSetCommand extends GraphCommand {
  ...
  public getTelemetryProperties(args: CommandArgs): any {
    ...
    GraphTeamsMessageSettingsSetCommand.props.forEach(p => {
      ...
      .then((): request.RequestPromise => {
        ...
        GraphTeamsMessageSettingsSetCommand.props.forEach(p => {
          if (typeof (args.options as any)[p] !== 'undefined') {
            body.messagingSettings[p] = (args.options as any)[p] === 'true';
          }
        });
    ...
    const options: CommandOption[] = [
      {
        ...
        description: 'The ID of the Microsoft Teams team for which to update message settings'
      },
      {
  ...
  public validate(): CommandValidate {
    return (args: CommandArgs): boolean | string => {
      ...
      GraphTeamsMessageSettingsSetCommand.props.every(p => {
        property = p;
