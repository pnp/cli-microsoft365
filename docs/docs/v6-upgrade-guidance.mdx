...
`aad o365group restore` | [aad o365group recyclebinitem restore](./cmd/aad/m365group/m365group-recyclebinitem-restore.mdx) | Renamed to better match intention and naming convention.
