...
class TeamsTeamAddCommand extends GraphCommand {
  ...
  public commandHelp(args: {}, log: (help: string) => void): void {
    ...
    This command will return different responses based on the presence of the ${chalk.grey('--wait')} option, 
    if present, the command will return a ${chalk.grey('group')} resource in the response, 
    if not present, the command will return a ${chalk.grey('teamsAsyncOperation')} resource in the response.
