...
In the previous version of CLI for Microsoft 365, you could get deleted groups in Azure AD using the command `aad o365group list` by providing the flag `deleted`. In the latest release, we have removed this option from the command. To get all deleted groups in your tenant, you can now use the command [aad o365group recyclebinitem list](./cmd/aad/o365group/o365group-recyclebinitem-list.mdx).

### What action do I need to take?

In your scripts, use the command [aad o365group recyclebinitem list](./cmd/aad/o365group/o365group-recyclebinitem-list.mdx) instead of `aad o365group list --deleted`.
