...
describe(commands.PROJECT_UPGRADE, () => {
  ...
  //#region 1.15.2
  it('e2e: shows correct number of findings for upgrading ace 1.15.2 project to 1.16.0-rc.0', async () => {
    ...
    await command.action(logger, { options: { toVersion: '1.16.0-rc.0', output: 'json', preview: true } } as any);
    const findings: FindingToReport[] = log[0];
    assert.strictEqual(findings.length, 13);
  });

  it('e2e: shows correct number of findings for upgrading application customizer 1.15.2 project to 1.16.0-rc.0', async () => {
  ...
  it('e2e: shows correct number of findings for upgrading field customizer react 1.15.2 project to 1.16.0-rc.0', async () => {
  ...
  it('e2e: shows correct number of findings for upgrading form customizer react 1.15.2 project to 1.16.0-rc.0', async () => {
  ...
  it('e2e: shows correct number of findings for upgrading list view command set 1.15.2 project to 1.16.0-rc.0', async () => {
  ...
  it('e2e: shows correct number of findings for upgrading no framework web part 1.15.2 project to 1.16.0-rc.0', async () => {
  ...
  it('e2e: shows correct number of findings for upgrading react web part 1.15.2 project to 1.16.0-rc.0', async () => {
  ...
  it('e2e: shows correct number of findings for upgrading web part with optional dependencies 1.15.2 project to 1.16.0-rc.0', async () => {
