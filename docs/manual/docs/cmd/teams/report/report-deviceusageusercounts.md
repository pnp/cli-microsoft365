...
```sh
teams report deviceusageusercounts --period D7 --output text --outputFilePath 'C:/report.txt'
```
...
```sh
teams report deviceusageusercounts --period D7 --output json --outputFilePath 'C:/report.json'
```