...
class SpoFileCheckinCommand extends SpoCommand {
  ...
  public options(): CommandOption[] {
    const options: CommandOption[] = [
      ...
      {
        option: '-u, --url [url]',
        description: 'The server-relative URL of the file to retrieve. Specify either URL or UniqueId but not both'
      },
      {
        option: '-i, --id [id]',
        description: 'The UniqueId (GUID) of the file to retrieve. Specify either URL or UniqueId but not both'
      },
      {
        option: '-t, --type [type]',
      ...
      },
      {
        ...
        description: 'Comment to set when checking the file in. It\'s length must be less than 1024 letters. Default is empty string'
      }
    ];
  ...
  Examples:
    ...
    ${chalk.grey('https://contoso.sharepoint.com/sites/project-x')}
      ${chalk.grey(config.delimiter)} ${commands.FILE_CHECKIN} --webUrl https://contoso.sharepoint.com/sites/project-x --url '/sites/project-x/documents/Test1.docx'

    Checks in minor version of file with server-relative url
      ${chalk.grey('/sites/project-x/documents/Test1.docx')} located in site
      ${chalk.grey('https://contoso.sharepoint.com/sites/project-x')}
        ${chalk.grey(config.delimiter)} ${commands.FILE_CHECKIN} --webUrl https://contoso.sharepoint.com/sites/project-x --url '/sites/project-x/documents/Test1.docx' --type minor

    Checks in file ${chalk.grey('/sites/project-x/documents/Test1.docx')} with comment located in site
      ${chalk.grey('https://contoso.sharepoint.com/sites/project-x')}
        ${chalk.grey(config.delimiter)} ${commands.FILE_CHECKIN} --webUrl https://contoso.sharepoint.com/sites/project-x --url '/sites/project-x/documents/Test1.docx' --comment 'approved'
      `);
  }
}
