...
Retrieves information about the current Microsoft Entra ID app
...
```md definition-list
`--appId [appId]`
: Client ID of the Microsoft Entra ID app registered in the .m365rc.json file to retrieve information for.
```
...
Use this command to quickly look up information for the Microsoft Entra ID application registration registered in the .m365rc.json file in your current project (folder).
...
Retrieve information about your current Microsoft Entra ID app.

```sh
m365 app get
```

Retrieve information about the Microsoft Entra ID app with client ID specified in the _.m365rc.json_ file.
...
<Tabs>
  ...
  ```json
  {
    ...
    "displayName": "My Microsoft Entra ID app",
    "description": null,
  ...
  ## My Microsoft Entra ID app (b3241f2a-6551-43d4-a72f-0d02ccfeb77f)
