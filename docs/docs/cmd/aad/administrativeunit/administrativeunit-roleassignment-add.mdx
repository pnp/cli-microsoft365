...
```sh
m365 aad administrativeunit roleassignment add [options]
```
...
```sh
m365 aad administrativeunit roleassignment add --administrativeUnitName 'Marketing Division' --roleDefinitionName 'License Administrator' --userName 'john.doe@contoso.com'
```
