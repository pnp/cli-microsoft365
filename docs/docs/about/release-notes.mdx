...
- refactored to async/await `base commands`. [#4957](https://github.com/pnp/cli-microsoft365/issues/4957)
- refactored to async/await `m365 spo customaction`, `m365 spo commandset`. [#5021](https://github.com/pnp/cli-microsoft365/issues/5021)
- refactored to async/await - `m365 spo contenttype`, `m365 spo contenttypehub`. [#5022](https://github.com/pnp/cli-microsoft365/issues/5022)
