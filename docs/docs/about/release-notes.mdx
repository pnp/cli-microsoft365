...
- migrated purview retentionevent and retentioneventtype commands to Zod [#7315](https://github.com/pnp/cli-microsoft365/issues/7315)
- migrated purview commands to Zod schema validation [#7316](https://github.com/pnp/cli-microsoft365/issues/7316)
- migrated planner roster and task commands to Zod [#7312](https://github.com/pnp/cli-microsoft365/issues/7312)
...
- updated Docker images to use latest alpine image
- updated docs dependencies
- added minimal permission for 'spo file related' commands [#7270](https://github.com/pnp/cli-microsoft365/issues/7270)
- added minimal permissions for 'spo hubsite' commands [#7279](https://github.com/pnp/cli-microsoft365/issues/7279)
- updated docs transitive dependencies
- renamed web alert commands and adds alias [#7036](https://github.com/pnp/cli-microsoft365/issues/7036)
- updated github workflows [#7452](https://github.com/pnp/cli-microsoft365/issues/7452)
