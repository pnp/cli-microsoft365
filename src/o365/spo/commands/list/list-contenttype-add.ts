...
class SpoListContentTypeAddCommand extends SpoCommand {
  ...
  Remarks:
    ...
    To add existing content type to a list, you have to first log in to SharePoint
    using the ${chalk.blue(commands.LOGIN)} command,
    eg. ${chalk.grey(`${config.delimiter} ${commands.LOGIN} https://contoso.sharepoint.com`)}.
        
  Examples:
  
    Add existing content type with ID ${chalk.grey('0x0120')} to the list with ID ${chalk.grey('0cd891ef-afce-4e55-b836-fce03286cccf')}
