...
: When specified, the command returns only objects of specified type. The possible values are `user`, `group` and `device`.

`-p, --properties [properties]`
: Comma-separated list of properties to retrieve.

`-f, --filter [filter]`
: OData filter to use to query the list of members with. Applied only when `memberType` is specified.
```
...
```sh
m365 aad administrativeunit member list --administrativeUnitId 03c4c9dc-6f0c-4c4f-a4e6-0c9ed80f54c7 --memberType user
```

List users of an administrative unit specified by id that are guest users

```sh
m365 aad administrativeunit member list --administrativeUnitId 03c4c9dc-6f0c-4c4f-a4e6-0c9ed80f54c7 --memberType user --filter "userType eq 'Guest'"
```

List groups of an administrative unit specified by id

```sh
m365 aad administrativeunit member list --administrativeUnitId 03c4c9dc-6f0c-4c4f-a4e6-0c9ed80f54c7 --memberType group
```
...
```sh
m365 aad administrativeunit member list --administrativeUnitId 03c4c9dc-6f0c-4c4f-a4e6-0c9ed80f54c7 --memberType group --properties 'id,displayName,owners/displayName'
```

List devices of an administrative unit specified by id

```sh
m365 aad administrativeunit member list --administrativeUnitId 03c4c9dc-6f0c-4c4f-a4e6-0c9ed80f54c7 --memberType device
```

List devices with linux operating system of an administrative unit specified by id

```sh
m365 aad administrativeunit member list --administrativeUnitId 03c4c9dc-6f0c-4c4f-a4e6-0c9ed80f54c7 --memberType device --filter "operatingSystem eq 'linux'"
```
