...
class TodoTaskSetCommand extends GraphCommand {
  ...
  private mapRequestBody(options: Options): any {
    ...
    if (options.importance) {
      requestBody.importance = options.importance;
    }

    requestBody.body = { contentType: 'text' };
    if (options.bodyContentType) {
      requestBody.body.contentType = options.bodyContentType;
    }

    if (options.bodyContent) {
      requestBody.body.content = options.bodyContent;
    }
