...
## Renamed every `aad o365group` command to `aad m365group`

In version 7 of the CLI for Microsoft 365, we have renamed the `aad o365group` commands to `aad m365group` as it has been some time since Office 365 was renamed to Microsoft 365. Office 365 groups are since then being named Microsoft 365 groups.

### What action do I need to take?

Replace every command using `aad o365group` to `aad m365group` in your scripts.
