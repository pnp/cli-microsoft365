...
class GraphTeamsGuestSettingsListCommand extends GraphCommand {
  ...
  public get description(): string {
    return 'Lists guest settings for a Microsoft Team';
  }
    ...
    auth
      ...
      .then((): request.RequestPromise => {
        const requestOptions: any = {
          url: `${auth.service.resource}/v1.0/teams/${args.options.teamId}?$select=guestSettings`,
  ...
  Remarks:
    ...
    To get guest settings for a Microsoft Team, you have to first log in to
