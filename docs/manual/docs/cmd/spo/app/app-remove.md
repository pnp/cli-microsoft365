...
Remove the specified app from a site colleciton app catalog of the site you are currently logged in.

```sh
spo app remove --id d95f8c94-67a1-4615-9af8-361ad33be93c --scope sitecollection
```
