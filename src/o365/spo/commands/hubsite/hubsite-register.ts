...
class SpoHubSiteRegisterCommand extends SpoCommand {
  ...
  public commandAction(cmd: CommandInstance, args: CommandArgs, cb: () => void): void {
    const resource: string = Auth.getResourceFromUrl(args.options.siteCollectionUrl);
    ...
    auth
      ...
      .then((accessToken: string): Promise<ContextInfo> => {
        ...
        return this.getRequestDigestForSite(args.options.siteCollectionUrl, siteAccessToken, cmd, this.debug);
      })
      .then((res: ContextInfo): Promise<HubSite> => {
        ...
        const requestOptions: any = {
          url: `${args.options.siteCollectionUrl}/_api/site/RegisterHubSite`,
  ...
  public options(): CommandOption[] {
    const options: CommandOption[] = [
      {
        option: '-u, --siteCollectionUrl <siteCollectionUrl>',
  ...
  public validate(): CommandValidate {
    return (args: CommandArgs): boolean | string => {
      if (!args.options.siteCollectionUrl) {
        return 'Required parameter siteCollectionUrl missing';
      }

      const isValidSharePointUrl: boolean | string = SpoCommand.isValidSharePointUrl(args.options.siteCollectionUrl);
  ...
  Examples:
    ...
    ${chalk.grey('https://contoso.sharepoint.com/sites/sales')} as a hub site
      ${chalk.grey(config.delimiter)} ${this.name} --siteCollectionUrl https://contoso.sharepoint.com/sites/sales
