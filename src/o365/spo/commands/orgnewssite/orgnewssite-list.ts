...
class SpoOrgNewsSiteListCommand extends SpoCommand {
  ...
  public get description(): string {
    return 'Lists URLs of all organizational news sites for the tenant';
  }
  ...
  Remarks:
    ...
    To list all sites identified as organizational news sites, you have to first log in to a tenant admin site using the
