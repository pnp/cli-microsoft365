...
describe(commands.PROJECT_DOCTOR, () => {
  ...
  it('e2e: shows correct number of findings for a valid 1.19.0-rc.0 project', async () => {
    sinon.stub(command as any, 'getProjectRoot').callsFake(_ => path.join(process.cwd(), 'src/m365/spfx/commands/project/test-projects/spfx-1190-rc0-webpart-react'));
