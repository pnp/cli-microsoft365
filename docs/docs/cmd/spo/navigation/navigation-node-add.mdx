...
<<<<<<< HEAD:docs/docs/cmd/spo/navigation/navigation-node-add.mdx
<Global />
=======
`--openInNewWindow`
...
>>>>>>> 94f42626e (Enhances `spo navigation node add` and `spo navigation node set`):docs/docs/cmd/spo/navigation/navigation-node-add.md
