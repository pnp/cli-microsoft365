...
export default [
  ...
  new FN003001_CFG_schema({ schema: 'https://dev.office.com/json-schemas/spfx-build/config.2.0.schema.json' }),
  new FN003002_CFG_version({ version: '2.0' }),
  new FN003003_CFG_bundles(),
  new FN003004_CFG_entries(),
  new FN003005_CFG_localizedResource_pathLib(),
  new FN004001_CFG_CA_schema({ schema: 'https://dev.office.com/json-schemas/spfx-build/copy-assets.schema.json' }),
  new FN005001_CFG_DAS_schema({ schema: 'https://dev.office.com/json-schemas/spfx-build/deploy-azure-storage.schema.json' }),
  new FN006001_CFG_PS_schema({ schema: 'https://dev.office.com/json-schemas/spfx-build/package-solution.schema.json' }),
  new FN007001_CFG_S_schema({ schema: 'https://dev.office.com/json-schemas/core-build/serve.schema.json' }),
  new FN008002_CFG_TSL_removeRule({ rule: 'no-unused-imports' }),
  new FN008001_CFG_TSL_schema({ schema: 'https://dev.office.com/json-schemas/core-build/tslint.schema.json' }),
  new FN009001_CFG_WM_schema({ schema: 'https://dev.office.com/json-schemas/spfx-build/write-manifests.schema.json' }),
  new FN010001_YORC_version({ version: '1.2.0' }),
  new FN011001_MAN_webpart_schema({ schema: 'https://dev.office.com/json-schemas/spfx/client-side-web-part-manifest.schema.json' }),
  new FN011002_MAN_applicationCustomizer_schema({ schema: 'https://dev.office.com/json-schemas/spfx/client-side-extension-manifest.schema.json' }),
  new FN011003_MAN_listViewCommandSet_schema({ schema: 'https://dev.office.com/json-schemas/spfx/command-set-extension-manifest.schema.json' }),
  new FN011004_MAN_fieldCustomizer_schema({ schema: 'https://dev.office.com/json-schemas/spfx/client-side-extension-manifest.schema.json' }),
  new FN011006_MAN_listViewCommandSet_items(),
  new FN011007_MAN_listViewCommandSet_removeCommands(),
  new FN014004_CODE_settings_jsonSchemas_configJson_url({ url: './node_modules/@microsoft/sp-build-core-tasks/lib/configJson/schemas/config-v1.schema.json' })
];