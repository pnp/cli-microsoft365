...
describe(commands.PROJECT_UPGRADE, () => {
  ...
  //#region 1.18.0
  it('e2e: shows correct number of findings for upgrading ace 1.18.0 project to 1.18.1', async () => {
  ...
  it('e2e: shows correct number of findings for upgrading application customizer 1.18.0 project to 1.18.1', async () => {
  ...
  //#region 1.18.1
  it('e2e: shows correct number of findings for upgrading ace 1.18.1 project to 1.18.2', async () => {
    sinon.stub(command as any, 'getProjectRoot').callsFake(_ => path.join(process.cwd(), 'src/m365/spfx/commands/project/test-projects/spfx-1181-ace'));
  ...
  it('e2e: shows correct number of findings for upgrading application customizer 1.18.1 project to 1.18.2', async () => {
    sinon.stub(command as any, 'getProjectRoot').callsFake(_ => path.join(process.cwd(), 'src/m365/spfx/commands/project/test-projects/spfx-1181-applicationcustomizer'));
  ...
  it('e2e: shows correct number of findings for upgrading field customizer react 1.18.1 project to 1.18.2', async () => {
    sinon.stub(command as any, 'getProjectRoot').callsFake(_ => path.join(process.cwd(), 'src/m365/spfx/commands/project/test-projects/spfx-1181-fieldcustomizer-react'));
  ...
  it('e2e: shows correct number of findings for upgrading form customizer react 1.18.1 project to 1.18.2', async () => {
    sinon.stub(command as any, 'getProjectRoot').callsFake(_ => path.join(process.cwd(), 'src/m365/spfx/commands/project/test-projects/spfx-1181-formcustomizer-react'));
  ...
  it('e2e: shows correct number of findings for upgrading list view command set 1.18.1 project to 1.18.2', async () => {
    sinon.stub(command as any, 'getProjectRoot').callsFake(_ => path.join(process.cwd(), 'src/m365/spfx/commands/project/test-projects/spfx-1181-listviewcommandset'));
  ...
  it('e2e: shows correct number of findings for upgrading no framework web part 1.18.1 project to 1.18.2', async () => {
    sinon.stub(command as any, 'getProjectRoot').callsFake(_ => path.join(process.cwd(), 'src/m365/spfx/commands/project/test-projects/spfx-1181-webpart-nolib'));
  ...
  it('e2e: shows correct number of findings for upgrading web part with optional dependencies 1.18.1 project to 1.18.2', async () => {
    sinon.stub(command as any, 'getProjectRoot').callsFake(_ => path.join(process.cwd(), 'src/m365/spfx/commands/project/test-projects/spfx-1181-webpart-optionaldeps'));
  ...
  //#region 1.19.0
  it('e2e: shows correct number of findings for upgrading ace 1.19.0 project to 1.20.0', async () => {
    sinon.stub(command as any, 'getProjectRoot').callsFake(_ => path.join(process.cwd(), 'src/m365/spfx/commands/project/test-projects/spfx-1190-ace'));
  ...
  it('e2e: shows correct number of findings for upgrading application customizer 1.19.0 project to 1.20.0', async () => {
    sinon.stub(command as any, 'getProjectRoot').callsFake(_ => path.join(process.cwd(), 'src/m365/spfx/commands/project/test-projects/spfx-1190-applicationcustomizer'));
  ...
  it('e2e: shows correct number of findings for upgrading field customizer react 1.19.0 project to 1.20.0', async () => {
    sinon.stub(command as any, 'getProjectRoot').callsFake(_ => path.join(process.cwd(), 'src/m365/spfx/commands/project/test-projects/spfx-1190-fieldcustomizer-react'));
  ...
  it('e2e: shows correct number of findings for upgrading form customizer react 1.19.0 project to 1.20.0', async () => {
    sinon.stub(command as any, 'getProjectRoot').callsFake(_ => path.join(process.cwd(), 'src/m365/spfx/commands/project/test-projects/spfx-1190-formcustomizer-react'));
  ...
  it('e2e: shows correct number of findings for upgrading no framework web part 1.19.0 project to 1.20.0', async () => {
    sinon.stub(command as any, 'getProjectRoot').callsFake(_ => path.join(process.cwd(), 'src/m365/spfx/commands/project/test-projects/spfx-1190-webpart-nolib'));
  ...
  it('e2e: shows correct number of findings for upgrading web part with optional dependencies 1.19.0 project to 1.20.0', async () => {
    sinon.stub(command as any, 'getProjectRoot').callsFake(_ => path.join(process.cwd(), 'src/m365/spfx/commands/project/test-projects/spfx-1190-webpart-optionaldeps'));
  ...
  //#region 1.21.1
  it('e2e: shows correct number of findings for upgrading ace 1.21.1 project to 1.22.0', async () => {
    ...
    await command.action(logger, { options: { toVersion: '1.22.0', preview: false, output: 'json' } } as any);
    const findings: FindingToReport[] = log[0];
    assert.strictEqual(findings.length, 43);
  });

  it('e2e: shows correct number of findings for upgrading application customizer 1.21.1 project to 1.22.0', async () => {
  ...
  it('e2e: shows correct number of findings for upgrading field customizer react 1.21.1 project to 1.22.0', async () => {
  ...
  it('e2e: shows correct number of findings for upgrading form customizer react 1.21.1 project to 1.22.0', async () => {
  ...
  it('e2e: shows correct number of findings for upgrading list view command set 1.21.1 project to 1.22.0', async () => {
  ...
  it('e2e: shows correct number of findings for upgrading no framework web part 1.21.1 project to 1.22.0', async () => {
  ...
  it('e2e: shows correct number of findings for upgrading react web part 1.21.1 project to 1.22.0', async () => {
  ...
  it('e2e: shows correct number of findings for upgrading web part with optional dependencies 1.21.1 project to 1.22.0', async () => {
  ...
  //#region 1.22.0
  it('e2e: shows correct number of findings for upgrading ace 1.22.0 project to 1.22.1', async () => {
    sinon.stub(command as any, 'getProjectRoot').callsFake(_ => path.join(process.cwd(), 'src/m365/spfx/commands/project/test-projects/spfx-1220-ace'));

    await command.action(logger, { options: { toVersion: '1.22.1', preview: false, output: 'json' } } as any);
    const findings: FindingToReport[] = log[0];
    assert.strictEqual(findings.length, 10);
  });

  it('e2e: shows correct number of findings for upgrading application customizer 1.22.0 project to 1.22.1', async () => {
    sinon.stub(command as any, 'getProjectRoot').callsFake(_ => path.join(process.cwd(), 'src/m365/spfx/commands/project/test-projects/spfx-1220-applicationcustomizer'));
  ...
  it('e2e: shows correct number of findings for upgrading field customizer react 1.22.0 project to 1.22.1', async () => {
    sinon.stub(command as any, 'getProjectRoot').callsFake(_ => path.join(process.cwd(), 'src/m365/spfx/commands/project/test-projects/spfx-1220-fieldcustomizer-react'));
  ...
  it('e2e: shows correct number of findings for upgrading form customizer react 1.22.0 project to 1.22.1', async () => {
    sinon.stub(command as any, 'getProjectRoot').callsFake(_ => path.join(process.cwd(), 'src/m365/spfx/commands/project/test-projects/spfx-1220-formcustomizer-react'));
  ...
  it('e2e: shows correct number of findings for upgrading list view command set 1.22.0 project to 1.22.1', async () => {
    sinon.stub(command as any, 'getProjectRoot').callsFake(_ => path.join(process.cwd(), 'src/m365/spfx/commands/project/test-projects/spfx-1220-listviewcommandset'));
  ...
  it('e2e: shows correct number of findings for upgrading no framework web part 1.22.0 project to 1.22.1', async () => {
    sinon.stub(command as any, 'getProjectRoot').callsFake(_ => path.join(process.cwd(), 'src/m365/spfx/commands/project/test-projects/spfx-1220-webpart-nolib'));
  ...
  it('e2e: shows correct number of findings for upgrading react web part 1.22.0 project to 1.22.1', async () => {
  ...
  it('e2e: shows correct number of findings for upgrading web part with optional dependencies 1.22.0 project to 1.22.1', async () => {
    sinon.stub(command as any, 'getProjectRoot').callsFake(_ => path.join(process.cwd(), 'src/m365/spfx/commands/project/test-projects/spfx-1220-webpart-optionaldeps'));
  ...
  //#region 1.22.1
  it('e2e: shows correct number of findings for upgrading ace 1.22.1 project to 1.22.2', async () => {
    sinon.stub(command as any, 'getProjectRoot').callsFake(_ => path.join(process.cwd(), 'src/m365/spfx/commands/project/test-projects/spfx-1221-ace'));
  ...
  it('e2e: shows correct number of findings for upgrading application customizer 1.22.1 project to 1.22.2', async () => {
    sinon.stub(command as any, 'getProjectRoot').callsFake(_ => path.join(process.cwd(), 'src/m365/spfx/commands/project/test-projects/spfx-1221-applicationcustomizer'));
  ...
  it('e2e: shows correct number of findings for upgrading field customizer react 1.22.1 project to 1.22.2', async () => {
    sinon.stub(command as any, 'getProjectRoot').callsFake(_ => path.join(process.cwd(), 'src/m365/spfx/commands/project/test-projects/spfx-1221-fieldcustomizer-react'));
  ...
  it('e2e: shows correct number of findings for upgrading form customizer react 1.22.1 project to 1.22.2', async () => {
    sinon.stub(command as any, 'getProjectRoot').callsFake(_ => path.join(process.cwd(), 'src/m365/spfx/commands/project/test-projects/spfx-1221-formcustomizer-react'));
  ...
  it('e2e: shows correct number of findings for upgrading list view command set 1.22.1 project to 1.22.2', async () => {
    sinon.stub(command as any, 'getProjectRoot').callsFake(_ => path.join(process.cwd(), 'src/m365/spfx/commands/project/test-projects/spfx-1221-listviewcommandset'));
  ...
  it('e2e: shows correct number of findings for upgrading no framework web part 1.22.1 project to 1.22.2', async () => {
    sinon.stub(command as any, 'getProjectRoot').callsFake(_ => path.join(process.cwd(), 'src/m365/spfx/commands/project/test-projects/spfx-1221-webpart-nolib'));
  ...
  it('e2e: shows correct number of findings for upgrading react web part 1.22.1 project to 1.22.2', async () => {
  ...
  it('e2e: shows correct number of findings for upgrading web part with optional dependencies 1.22.1 project to 1.22.2', async () => {
    sinon.stub(command as any, 'getProjectRoot').callsFake(_ => path.join(process.cwd(), 'src/m365/spfx/commands/project/test-projects/spfx-1221-webpart-optionaldeps'));
  ...
  //#region 1.23.0
  it('e2e: shows correct number of findings for upgrading ace 1.23.0 project to 1.23.2', async () => {
    sinon.stub(command as any, 'getProjectRoot').callsFake(_ => path.join(process.cwd(), 'src/m365/spfx/commands/project/test-projects/spfx-1230-ace'));

    await command.action(logger, { options: { toVersion: '1.23.2', preview: false, output: 'json' } } as any);
    const findings: FindingToReport[] = log[0];
    assert.strictEqual(findings.length, 10);
  });

  it('e2e: shows correct number of findings for upgrading application customizer 1.23.0 project to 1.23.2', async () => {
    sinon.stub(command as any, 'getProjectRoot').callsFake(_ => path.join(process.cwd(), 'src/m365/spfx/commands/project/test-projects/spfx-1230-applicationcustomizer'));
  ...
  it('e2e: shows correct number of findings for upgrading field customizer react 1.23.0 project to 1.23.2', async () => {
    sinon.stub(command as any, 'getProjectRoot').callsFake(_ => path.join(process.cwd(), 'src/m365/spfx/commands/project/test-projects/spfx-1230-fieldcustomizer-react'));
  ...
  it('e2e: shows correct number of findings for upgrading form customizer no lib 1.23.0 project to 1.23.2', async () => {
    sinon.stub(command as any, 'getProjectRoot').callsFake(_ => path.join(process.cwd(), 'src/m365/spfx/commands/project/test-projects/spfx-1230-formcustomizer-nolib'));
  ...
  it('e2e: shows correct number of findings for upgrading form customizer react 1.23.0 project to 1.23.2', async () => {
    sinon.stub(command as any, 'getProjectRoot').callsFake(_ => path.join(process.cwd(), 'src/m365/spfx/commands/project/test-projects/spfx-1230-formcustomizer-react'));
  ...
  it('e2e: shows correct number of findings for upgrading list view command set 1.23.0 project to 1.23.2', async () => {
    sinon.stub(command as any, 'getProjectRoot').callsFake(_ => path.join(process.cwd(), 'src/m365/spfx/commands/project/test-projects/spfx-1230-listviewcommandset'));
  ...
  it('e2e: shows correct number of findings for upgrading no framework web part 1.23.0 project to 1.23.2', async () => {
    sinon.stub(command as any, 'getProjectRoot').callsFake(_ => path.join(process.cwd(), 'src/m365/spfx/commands/project/test-projects/spfx-1230-webpart-nolib'));
  ...
  it('e2e: shows correct number of findings for upgrading react web part 1.23.0 project to 1.23.2', async () => {
  ...
  it('e2e: shows correct number of findings for upgrading web part with optional dependencies 1.23.0 project to 1.23.2', async () => {
    sinon.stub(command as any, 'getProjectRoot').callsFake(_ => path.join(process.cwd(), 'src/m365/spfx/commands/project/test-projects/spfx-1230-webpart-optionaldeps'));
