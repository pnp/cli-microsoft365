  ...
  it('fails when multiple Microsoft Entra apps with same name exists', async () => {
    ...
    getRequestStub.onCall(1)
      .callsFake(async (opts) => {
        ...
        throw 'Multiple Microsoft Entra app with displayName Foo App found: 3166f9d8-f4e9-4b56-b634-dafcc9ecba8e,9bd7b7c0-e4a7-4b85-b0c6-20aaca0e25b7';
      });
    ...
    } as any), new CommandError('Multiple Microsoft Entra app with displayName Foo App found: 3166f9d8-f4e9-4b56-b634-dafcc9ecba8e,9bd7b7c0-e4a7-4b85-b0c6-20aaca0e25b7'));
  });
