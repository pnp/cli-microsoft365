...
If you want to use a different authentication method, please refer to the [log in to Microsoft 365 documentation](../getting-started/connecting-microsoft-365) or the [login command documentation](../../cmd/login.mdx).
