...
```sh
m365 entra pim role assignment add --roleDefinitionId 'f1417aa3-bf0b-4cc5-a845-a0b2cf11f690' --userId '3488d6b8-6b2e-41c3-9583-1991205323c2' --directoryScopeId '/'
```
...
```sh
m365 entra pim role assignment add --roleDefinitionName 'User Administrator' --groupId '3488d6b8-6b2e-41c3-9583-1991205323c2' --directoryScopeId '/administrativeUnits/03c4c9dc-6f0c-4c4f-a4e6-0c9ed80f54c7'
```
...
```sh
m365 entra pim role assignment add --roleDefinitionName 'Application Administrator' --groupName 'Applications admins' --directoryScopeId '/03c4c9dc-6f0c-4c4f-a4e6-0c9ed80f54c7'
```
