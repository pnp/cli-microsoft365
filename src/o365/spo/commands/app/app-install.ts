...
class AppInstallCommand extends SpoCommand {
  ...
  public get description(): string {
    return 'Installs an app from the app catalog into the site';
  }
  ...
  public commandAction(cmd: CommandInstance, args: CommandArgs, cb: () => void): void {
    ...
    auth
      ...
      .then((res: ContextInfo): Promise<string> => {
        ...
        const requestOptions: any = {
          url: `${auth.site.url}/_api/web/tenantappcatalog/AvailableApps/GetByID('${args.options.identity}')/install`,
          headers: {
  ...
  Examples:
    ...
    ${chalk.grey(config.delimiter)} ${commands.APP_INSTALL} --identity 058140e3-0e37-44fc-a1d3-79c487d371a3
      Installs the given app from the tenant app catalog into a site.
