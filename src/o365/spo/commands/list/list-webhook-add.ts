...
class SpoListWebhookSetCommand extends SpoCommand {
  ...
  Examples:
    ...
    ${chalk.grey('https://contoso-funcions.azurewebsites.net/webhook')} and the default expiration date
    ${chalk.grey(config.delimiter)} ${commands.LIST_WEBHOOK_ADD} --webUrl https://contoso.sharepoint.com/sites/ninja --listTitle Documents --notificationUrl https://contoso-funcions.azurewebsites.net/webhook

    Add a web hook to the list ${chalk.grey('Documents')} located in site 
    ${chalk.grey('https://contoso.sharepoint.com/sites/ninja')} with the notification url 
    ${chalk.grey('https://contoso-funcions.azurewebsites.net/webhook')} and an expiration date of ${chalk.grey('January 21st, 2019')}
    ${chalk.grey(config.delimiter)} ${commands.LIST_WEBHOOK_ADD} --webUrl https://contoso.sharepoint.com/sites/ninja --listTitle Documents --notificationUrl https://contoso-funcions.azurewebsites.net/webhook --expirationDateTime 2019-01-21
    
    Add a web hook to the list ${chalk.grey('Documents')} located in site 
    ${chalk.grey('https://contoso.sharepoint.com/sites/ninja')} with the notification url 
    ${chalk.grey('https://contoso-funcions.azurewebsites.net/webhook')}, a very specific expiration date
    of ${chalk.grey('6:15 PM on March 2nd, 2019')} and a client state
    ${chalk.grey(config.delimiter)} ${commands.LIST_WEBHOOK_ADD} --webUrl https://contoso.sharepoint.com/sites/ninja --listTitle Documents --notificationUrl https://contoso-funcions.azurewebsites.net/webhook --expirationDateTime '2019-03-02T18:15' --clientState "Hello State!"
      `);
  }
}
