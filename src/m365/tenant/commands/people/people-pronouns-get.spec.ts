...
import command from './people-pronouns-get.js';

describe(commands.PEOPLE_PRONOUNS_GET, () => {
  let log: string[];
  let logger: Logger;
  ...
  it('has correct name', () => {
    assert.strictEqual(command.name, commands.PEOPLE_PRONOUNS_GET);
  });
  ...
  it(`should get pronouns settings`, async () => {
