...
!!! attention
    ...
    If this cannot be found, a request will be made to the Microsoft Graph. For this request to be succesful, you must ensure that you have at least the `Sites.Read.All` permission granted to your application.
