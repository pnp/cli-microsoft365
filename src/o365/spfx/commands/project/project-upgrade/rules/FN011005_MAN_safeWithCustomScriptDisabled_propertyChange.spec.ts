...
import { FN011005_MAN_safeWithCustomScriptDisabled_propertyChange } from './FN011005_MAN_safeWithCustomScriptDisabled_propertyChange';

describe('FN011005_MAN_safeWithCustomScriptDisabled_propertyChange', () => {
  let findings: Finding[];
  let rule: FN011005_MAN_safeWithCustomScriptDisabled_propertyChange;

  beforeEach(() => {
    findings = [];
    rule = new FN011005_MAN_safeWithCustomScriptDisabled_propertyChange();
  });
