...
You must have admin permissions to run this command.
...
```sh
m365 pa app owner set --environmentName Default-716eb9fb-bf79-4be9-b0c7-900824fcbe25 --apName 7ab97923-4a4d-4467-b030-12071d2b810b --userName john.doe@contoso.com
```
...
<Tabs>
  ...
  ```md
  # m365 pa app owner set --environmentName Default-e1dd4023-a656-480a-8a0e-c1b1eec51e1d --apName fe36f75e-c103-410b-a18a-2bf6df06ac3a --userName user@tenant.onmicrosoft.com
