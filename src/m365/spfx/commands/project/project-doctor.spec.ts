...
describe(commands.PROJECT_DOCTOR, () => {
  ...
  it('e2e: shows correct number of findings for a valid 1.23.1 project', async () => {
    sinon.stub(command as any, 'getProjectRoot').callsFake(_ => path.join(process.cwd(), 'src/m365/spfx/commands/project/test-projects/spfx-1231-webpart-react'));
