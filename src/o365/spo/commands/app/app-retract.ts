...
class SpoAppRetractCommand extends SpoAppBaseCommand {
  ...
  Remarks:
    ...
    To retract an app from the tenant or site colleciton app catalog, you have to first log in to a SharePoint site
  ...
  Examples:
    ...
    Retract the specified app from the tenant or site app catalog. Try to resolve the URL
