...
class SpoSiteDesignTaskRemoveCommand extends SpoCommand {
  ...
  public commandHelp(args: {}, log: (help: string) => void): void {
    ...
    Removes the specified site design task with taskId ${chalk.grey('6ec3ca5b-d04b-4381-b169-61378556d76e')} scheduled for execution without prompting confirmation
      ${this.name} --taskId 6ec3ca5b-d04b-4381-b169-61378556d76e --confirm

    Removes the specified site design task with taskId ${chalk.grey('6ec3ca5b-d04b-4381-b169-61378556d76e')} scheduled for execution with prompt for confirmation before removing
