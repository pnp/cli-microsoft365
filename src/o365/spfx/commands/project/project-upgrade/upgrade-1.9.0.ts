...
module.exports = [
  new FN001001_DEP_microsoft_sp_core_library('1.9.0'),
  new FN001002_DEP_microsoft_sp_lodash_subset('1.9.0'),
  new FN001003_DEP_microsoft_sp_office_ui_fabric_core('1.9.0'),
  new FN001004_DEP_microsoft_sp_webpart_base('1.9.0'),
  new FN001005_DEP_types_react('16.8.8'),
  new FN001006_DEP_types_react_dom('16.8.3'),
  new FN001021_DEP_microsoft_sp_property_pane('1.9.0'),
  new FN001011_DEP_microsoft_sp_dialog('1.9.0'),
  new FN001012_DEP_microsoft_sp_application_base('1.9.0'),
  new FN001013_DEP_microsoft_decorators('1.9.0'),
  new FN001014_DEP_microsoft_sp_listview_extensibility('1.9.0'),
  new FN001022_DEP_office_ui_fabric_react('6.189.2'),
  new FN002001_DEVDEP_microsoft_sp_build_web('1.9.0'),
  new FN002002_DEVDEP_microsoft_sp_module_interfaces('1.9.0'),
  new FN002003_DEVDEP_microsoft_sp_webpart_workbench('1.9.0'),
  new FN002009_DEVDEP_microsoft_sp_tslint_rules('1.9.0'),
  new FN002011_DEVDEP_microsoft_rush_stack_compiler_2_9('0.7.16'),
  new FN010001_YORC_version('1.9.0'),
