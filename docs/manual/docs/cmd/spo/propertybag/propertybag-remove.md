...
```sh
spo propertybag remove -u https://contoso.sharepoint.com/sites/test -k key1 -f / --confirm
```
...
```sh
spo propertybag remove --webUrl https://contoso.sharepoint.com/sites/test -u https://contoso.sharepoint.com/sites/test -k key1 -f '/Shared Documents/MyFolder'
```
