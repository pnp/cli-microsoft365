...
`-s, --section <sectionId>`|ID of the section where the column is located
...
To get information about the specific column of a modern page, you have to first connect to a SharePoint site using the [spo connect](../connect.md) command, eg. `spo connect https://contoso.sharepoint.com`.

If the specified name doesn't refer to an existing modern page, you will get a _File doesn't exists_ error.

## Examples

Get information about the specific column of a modern page with name _home.aspx_
