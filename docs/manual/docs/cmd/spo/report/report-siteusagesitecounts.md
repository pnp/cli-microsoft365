...
```sh
spo report siteusagesitecounts --period D7 --output text --outputFile 'C:/report.txt'
```
...
```sh
spo report siteusagesitecounts --period D7 --output json --outputFile 'C:/report.json'
```
