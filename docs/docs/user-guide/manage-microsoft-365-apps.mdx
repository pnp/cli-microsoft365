...
To help you, CLI for Microsoft 365 offers you two things. First, when creating an Microsoft Entra app registration for your Microsoft 365 app, store a reference to it. You do this, by extending the `m365 entra app add` command with the `--save` flag:
