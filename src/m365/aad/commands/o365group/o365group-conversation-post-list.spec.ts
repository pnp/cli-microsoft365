...
describe(commands.O365GROUP_CONVERSATION_POST_LIST, () => {
  ...
  it('correctly handles error when listing posts', (done) => {
    ...
    command.action(logger, { options: { debug: false, groupId: "00000000-0000-0000-0000-000000000000", threadId: "AAQkADkwN2Q2NDg1LWQ3ZGYtNDViZi1iNGRiLTVhYjJmN2Q5NDkxZQAQAOnRAfDf71lIvrdK85FAn5E=" } } as any, (err?: any) => {
      try {
