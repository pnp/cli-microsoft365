...
: Sets default share link scope for SharePoint Embedded. Allowed values `Anyone`, `Organization`, `SpecificPeople`, `Uninitialized`.
...
: Sets default share link to existing access for SharePoint Embedded. Allowed values `true`, `false`.
...
: Modern list template IDs to hide when creating a new list. An array of GUIDs split by a comma. Example: `c9b1909e-901a-0000-2cdb-e91c3f46320a,c9b1909e-901a-0000-2cdb-e91c3f463201`.
...
: Enables or disables the "Sync" button on all document libraries in SharePoint sites and OneDrive for Business sites. Allowed values `true`, `false`.
