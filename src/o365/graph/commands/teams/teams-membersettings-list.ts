...
class GraphTeamsMemberSettingsListCommand extends GraphCommand {
  ...
  public get description(): string {
    return 'Lists member settings for a Microsoft Team';
  }
    ...
    auth
      ...
      .then((): request.RequestPromise => {
        const requestOptions: any = {
          url: `${auth.service.resource}/v1.0/teams/${args.options.teamId}?$select=memberSettings`,
  ...
  Remarks:
    ...
    To get member settings for a Microsoft Team, you have to first log in to
