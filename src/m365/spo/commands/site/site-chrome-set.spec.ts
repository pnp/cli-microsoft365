...
describe(commands.SITE_CHROME_SET, () => {
  ...
  it('Validate if no error is thrown', (done) => {
  ...
  it('Validate default values', (done) => {
    let data: any = {};
    sinon.stub(request, 'post').callsFake((opts) => {
      if (opts.url === `https://contoso.sharepoint.com/sites/test/_api/web/SetChromeOptions`) {
        data = opts.data;
  ...
  it('Validate if mega menu gets disabled', (done) => {
    let data: any = {};
    sinon.stub(request, 'post').callsFake((opts) => {
      if (opts.url === `https://contoso.sharepoint.com/sites/test/_api/web/SetChromeOptions`) {
        data = opts.data;
  ...
  it('Validate if footer gets disabled', (done) => {
    let data: any = {};
    sinon.stub(request, 'post').callsFake((opts) => {
      if (opts.url === `https://contoso.sharepoint.com/sites/test/_api/web/SetChromeOptions`) {
        data = opts.data;
  ...
  it('Validate if title in header gets disabled', (done) => {
    let data: any = {};
    sinon.stub(request, 'post').callsFake((opts) => {
      if (opts.url === `https://contoso.sharepoint.com/sites/test/_api/web/SetChromeOptions`) {
        data = opts.data;
  ...
  it('Validate with custom values', (done) => {
    let data: any = {};
    sinon.stub(request, 'post').callsFake((opts) => {
      if (opts.url === `https://contoso.sharepoint.com/sites/test/_api/web/SetChromeOptions`) {
        data = opts.data;
