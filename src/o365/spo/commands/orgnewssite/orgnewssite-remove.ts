...
class SpoOrgNewsSiteRemoveCommand extends SpoCommand {
  ...
  public get description(): string {
    return 'Removes a given site from the list of organizational news sites';
  }
  ...
  Remarks:
    ...
    To remove a site from the list of organizational news sites, you have to first log in to a tenant admin site using the
  ...
  Examples:
    ...
    Remove a site from the list of organizational news sites
      ${chalk.grey(config.delimiter)} ${commands.ORGNEWSSITE_REMOVE} -u https://contoso.sharepoint.com/sites/site1

    Remove a site from the list of organizational news sites, without prompting for confirmation
      ${chalk.grey(config.delimiter)} ${commands.ORGNEWSSITE_REMOVE} -u https://contoso.sharepoint.com/sites/site1 --confirm
  `);
  }
}
