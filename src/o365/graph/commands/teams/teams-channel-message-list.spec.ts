...
const command: Command = require('./teams-channel-message-list');
import * as assert from 'assert';
import * as request from 'request-promise-native';
import Utils from '../../../../Utils';
import { Service } from '../../../../Auth';

describe(commands.TEAMS_CHANNEL_MESSAGE_LIST, () => {
  let vorpal: Vorpal;
  let log: string[];
  let cmdInstance: any;
  ...
  it('has correct name', () => {
    assert.equal(command.name.startsWith(commands.TEAMS_CHANNEL_MESSAGE_LIST), true);
  });
  ...
  it('logs correct telemetry event', (done) => {
    ...
    cmdInstance.action({ options: {} }, () => {
      try {
        assert.equal(telemetry.name, commands.TEAMS_CHANNEL_MESSAGE_LIST);
        done();
      }
      catch (e) {
        done(e);
  ...
  it('has help referring to the right command', () => {
    ...
    cmd.help({}, () => { });
    assert(find.calledWith(commands.TEAMS_CHANNEL_MESSAGE_LIST));
  });
  ...
  it('lists the message (debug)', (done) => {
