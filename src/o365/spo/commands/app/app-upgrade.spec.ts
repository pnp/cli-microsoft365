...
const appUpgradeCommand: Command = require('./app-upgrade');
...
describe(commands.APP_UPGRADE, () => {
  ...
  it('has correct name', () => {
    assert.equal(appUpgradeCommand.name.startsWith(commands.APP_UPGRADE), true);
  });

  it('has a description', () => {
    assert.notEqual(appUpgradeCommand.description, null);
  });

  it('calls telemetry', (done) => {
    cmdInstance.action = appUpgradeCommand.action();
  ...
  it('supports verbose mode', () => {
    const options = (appUpgradeCommand.options() as CommandOption[]);
  ...
  it('has help referring to the right command', () => {
    ...
    (appUpgradeCommand.help() as CommandHelp)({}, helpLog);
  ...
  it('has help with examples', () => {
    ...
    (appUpgradeCommand.help() as CommandHelp)({}, log);
