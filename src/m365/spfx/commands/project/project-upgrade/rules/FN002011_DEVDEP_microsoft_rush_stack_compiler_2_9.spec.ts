...
import { FN002011_DEVDEP_microsoft_rush_stack_compiler_2_9 } from './FN002011_DEVDEP_microsoft_rush_stack_compiler_2_9.js';
...
describe('FN002011_DEVDEP_microsoft_rush_stack_compiler_2_9', () => {
  ...
  beforeEach(() => {
    findings = [];
    rule = new FN002011_DEVDEP_microsoft_rush_stack_compiler_2_9({ packageVersion: '1.0.0', isOptional: true });
  });
