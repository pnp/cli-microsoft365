...
describe(commands.PROJECT_UPGRADE, () => {
  ...
  //#region 1.12.1
  it('e2e: shows correct number of findings for upgrading application customizer 1.12.1 project to 1.13.0-beta.20', () => {
    ...
    command.action(logger, { options: { toVersion: '1.13.0-beta.20', output: 'json' } } as any, () => {
      const findings: FindingToReport[] = log[0];
      assert.strictEqual(findings.length, 13);
    });
  });

  it('e2e: shows correct number of findings for upgrading field customizer react 1.12.1 project to 1.13.0-beta.20', () => {
  ...
  it('e2e: shows correct number of findings for upgrading list view command set 1.12.1 project to 1.13.0-beta.20', () => {
  ...
  it('e2e: shows correct number of findings for upgrading no framework web part 1.12.1 project to 1.13.0-beta.20', () => {
  ...
  it('e2e: shows correct number of findings for upgrading react web part 1.12.1 project to 1.13.0-beta.20', () => {
  ...
  it('e2e: shows correct number of findings for upgrading web part with optional dependencies 1.12.1 project to 1.13.0-beta.20', () => {
  ...
  it('upgrades project to the latest preview version using the preview option', () => {
    ...
    command.action(logger, { options: { preview: true } } as any, () => {
      assert(log[0].indexOf('1.13.0-beta.20') > -1);
    });
  });
