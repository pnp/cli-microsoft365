...
<Tabs>
  ...
  ```text
  id                                                                  principalId                           roleDefinitionId                      directoryScopeId                                           appScopeId  startDateTime             endDateTime  assignmentType  memberType  roleAssignmentOriginId                                              roleAssignmentScheduleId                                            principal
  ------------------------------------------------------------------  ------------------------------------  ------------------------------------  ---------------------------------------------------------  ----------  ------------------------  -----------  --------------  ----------  ------------------------------------------------------------------  ------------------------------------------------------------------  ---------------
