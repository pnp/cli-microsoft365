...
```sh
spo list webhook get --id cc27a922-8224-4296-90a5-ebbc54da2e85 --listId 0cd891ef-afce-4e55-b836-fce03286cccf --webUrl https://contoso.sharepoint.com/sites/project-x
```
...
```sh
spo list webhook get --id cc27a922-8224-4296-90a5-ebbc54da2e85 --listTitle Documents --webUrl https://contoso.sharepoint.com/sites/project-x
```