...
Gets information about the specified Entra ID Group
...
```md definition-list
`-i, --id [id]`
: The object Id of the Entra ID group. Specify either `id` or `displayName` but not both.

`-n, --displayName [displayName]`
: The display name of the Entra ID group. Specify either `id` or `displayName` but not both.
```
...
Get information about an Entra ID Group by id

```sh
m365 entra group get --id 1caf7dcd-7e83-4c3a-94f7-932a1299c844
```

Get information about an Entra ID Group by its display name
