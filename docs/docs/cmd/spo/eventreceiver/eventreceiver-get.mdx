...
Retrieve an event receiver in the specified web with the given name.

```sh
m365 spo eventreceiver get --webUrl https://contoso.sharepoint.com/sites/contoso-sales --name 'PnP Test Receiver'
```

Retrieve an event receiver in the specified site with the given id.
...
Retrieve an event receiver for list with given title in the specified web with the given name.
...
Retrieve an event receiver for list with given ID in the specified web with the given id.
...
Retrieve an event receiver for list with given url in the specified web with the given name.
