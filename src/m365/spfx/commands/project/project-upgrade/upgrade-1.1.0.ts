...
export default [
  ...
  new FN001015_DEP_types_react_addons_shallow_compare({ packageVersion: '0.14.17', add: true }),
  new FN001016_DEP_types_react_addons_update({ packageVersion: '0.14.14', add: true }),
  new FN001017_DEP_types_react_addons_test_utils({ packageVersion: '0.14.15', add: true }),
  new FN001018_DEP_microsoft_sp_client_base({ packageVersion: '', add: false }),
  ...
  new FN010001_YORC_version({ version: '1.1.0' }),
  new FN010005_YORC_environment({ environment: 'spo' }),
  new FN010006_YORC_framework({ framework: '', add: false }),
  new FN011009_MAN_webpart_safeWithCustomScriptDisabled({ add: true }),
