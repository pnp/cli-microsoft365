...
import { FN021008_PKG_scripts_start } from './FN021008_PKG_scripts_start.js';

describe('FN021008_PKG_scripts_start', () => {
  let findings: Finding[];
  let rule: FN021008_PKG_scripts_start;

  beforeEach(() => {
    findings = [];
    rule = new FN021008_PKG_scripts_start('heft start --clean');
  });
