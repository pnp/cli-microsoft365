...
- used SharePoint APIs in the [spo contenttype sync](../cmd/spo/contenttype/contenttype-sync.mdx) command [#7251](https://github.com/pnp/cli-microsoft365/issues/7251)
