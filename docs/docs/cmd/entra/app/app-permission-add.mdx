...
Adds the specified application and/or delegated permissions to a specified Microsoft Entra app
...
Grant multiple delegated API permissions to an Microsoft Entra app specified by client id
...
Grant multiple delegated API permissions to an Microsoft Entra app specified by object id
...
Grant multiple app-only permissions to an Microsoft Entra app specified by client id and grant admin consent
