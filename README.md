...
>On your first login you will be asked to consent to several permissions that the `PnP Office 365 Management Shell` multi-tenant app requires for the commands to work successfully against your tenant. If you want to create your own identity to use with the CLI, refer to the [Using your own Azure AD Identity](user-guide/using-own-identity/) guide.
