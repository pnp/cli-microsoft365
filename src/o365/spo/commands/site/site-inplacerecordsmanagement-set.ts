...
class SpoSiteInPlaceRecordsManagementSetCommand extends SpoCommand {
  ...
  Remarks:
    ...
    To activate or deactivate in-place records management, you have to first log in to SharePoint
    using the ${chalk.blue(commands.LOGIN)} command,
    eg. ${chalk.grey(`${config.delimiter} ${commands.LOGIN} https://contoso.sharepoint.com`)}.
  
  Examples:
  
    Activates in-place records management for site ${chalk.grey('https://contoso.sharepoint.com/sites/team-a')}
    ...
    Deactivates in-place records management for site ${chalk.grey('https://contoso.sharepoint.com/sites/team-a')}
