...
class Oauth2GrantAddCommand extends AadCommand {
  ...
  Remarks:
    ...
    To grant service principal OAuth2 permissions, you have to first connect to Azure Active Directory
  ...
  Examples:
    ...
    ${chalk.grey('Calendars.Read')} OAuth2 permissions to the ${chalk.grey('c2af2474-2c95-423a-b0e5-e4895f22f9e9')} resource.
      ${chalk.grey(config.delimiter)} ${commands.SP_GET} --clientId d03a0062-1aa6-43e1-8f49-d73e969c5812 --resourceId c2af2474-2c95-423a-b0e5-e4895f22f9e9 --scope Calendars.Read
    ...
    ${chalk.grey('Calendars.Read')} and ${chalk.grey('Mail.Read')} OAuth2 permissions to the ${chalk.grey('c2af2474-2c95-423a-b0e5-e4895f22f9e9')} resource.
      ${chalk.grey(config.delimiter)} ${commands.SP_GET} --clientId d03a0062-1aa6-43e1-8f49-d73e969c5812 --resourceId c2af2474-2c95-423a-b0e5-e4895f22f9e9 --scope "Calendars.Read Mail.Read"
