...
class GraphSchemaExtensionSetCommand extends GraphCommand {
  ...
  public getTelemetryProperties(args: CommandArgs): any {
    ...
    // Do not include in telemetry on purpose: id, owner, description, properties
  ...
  Examples:
    ...
    Update the target types and properties of a schema extension
      ${this.name} --id contoso_MySchemaExtension --owner 62375ab9-6b52-47ed-826b-58e47e0e304b --description "My schema extension" --targetTypes Group --owner 62375ab9-6b52-47ed-826b-58e47e0e304b --properties \`"[{""name"":""myProp1"",""type"":""Integer""},{""name"":""myProp2"",""type"":""String""}]\`
