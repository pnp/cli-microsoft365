  ...
  public async commandAction(logger: Logger, args: CommandArgs): Promise<void> {
    ...
    try {
      if (args.options.force) {
        ...
        const result = await Cli.promptForConfirmation(`Are you sure you want to restore the version ${args.options.label} from file ${args.options.fileId || args.options.fileUrl}'?`);
