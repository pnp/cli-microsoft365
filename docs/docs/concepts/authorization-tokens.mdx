...
CLI for Microsoft 365 gets access to Microsoft 365 through a custom Microsoft Entra application named _PnP Microsoft 365 Management Shell_. If you don't want to consent this application in your tenant, you can use a different application instead.
...
[![The 'public client' enabled for an Microsoft Entra application](../images/activate-public-client-aad-app.png)](../images/activate-public-client-aad-app.png)
...
For instructions on how to create your own Microsoft Entra app see [Using your own Microsoft Entra ID identity](../user-guide/using-own-identity.mdx).
