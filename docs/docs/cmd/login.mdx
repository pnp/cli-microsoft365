...
`--proxyUrl [proxyUrl]`
: The url of the proxy server to use when accessing the internet
```
...
Log in to Microsoft 365 using a proxy server.

```sh
m365 login --proxyUrl http://username:password@proxy.contoso.com:8080
```
