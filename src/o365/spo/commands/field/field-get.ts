...
class SpoFieldGetCommand extends SpoCommand {
  ...
  public get description(): string {
    return 'Retrieves information about the specified list field or site column';
  }
  ...
  Examples:
    ...
    Retrieves list field by id located in site ${chalk.grey('https://contoso.sharepoint.com/sites/contoso-sales')}. Retrieves the list by its title
    ...
    Retrieves list field by display name located in site ${chalk.grey('https://contoso.sharepoint.com/sites/contoso-sales')}. Retrieves the list by its url
