...
const appInstallCommand: Command = require('./app-install');
...
describe(commands.APP_INSTALL, () => {
  ...
  it('has correct name', () => {
    assert.equal(appInstallCommand.name.startsWith(commands.APP_INSTALL), true);
  });

  it('has a description', () => {
    assert.notEqual(appInstallCommand.description, null);
  });

  it('calls telemetry', (done) => {
    cmdInstance.action = appInstallCommand.action();
  ...
  it('supports verbose mode', () => {
    const options = (appInstallCommand.options() as CommandOption[]);
  ...
  it('has help referring to the right command', () => {
    ...
    (appInstallCommand.help() as CommandHelp)({}, helpLog);
  ...
  it('has help with examples', () => {
    ...
    (appInstallCommand.help() as CommandHelp)({}, log);
