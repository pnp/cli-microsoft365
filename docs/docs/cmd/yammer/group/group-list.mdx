...
In order to use this command, you need to grant the Microsoft Entra ID application used by the CLI for Microsoft 365 the permission to the Yammer API. To do this, execute the `cli consent --service yammer` command.
