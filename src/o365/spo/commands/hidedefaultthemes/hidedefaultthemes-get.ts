...
class SpoHideDefaultThemesGetCommand extends SpoCommand {
  ...
  public get description(): string {
    return 'Get the current value of the HideDefaultThemes setting';
  }
  ...
  Remarks:
    ...
    To get the current value of the HideDefaultThemes setting, you have to first connect to a tenant admin site using the
