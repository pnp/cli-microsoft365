...
const command: Command = require('./report-teamsdeviceusageusercounts');
import * as assert from 'assert';
import Utils from '../../../../Utils';
import { Service } from '../../../../Auth';
import request from '../../../../request';

describe(commands.REPORT_TEAMSDEVICEUSAGEUSERCOUNTS, () => {
  let vorpal: Vorpal;
  let log: string[];
  let cmdInstance: any;
  let trackEvent: any;
  ...
  it('has correct name', () => {
    assert.equal(command.name.startsWith(commands.REPORT_TEAMSDEVICEUSAGEUSERCOUNTS), true);
  });
  ...
  it('logs correct telemetry event', (done) => {
    ...
    cmdInstance.action({ options: {} }, () => {
      try {
        assert.equal(telemetry.name, commands.REPORT_TEAMSDEVICEUSAGEUSERCOUNTS);
        done();
      }
      catch (e) {
        done(e);
  ...
  it('has help referring to the right command', () => {
    ...
    cmd.help({}, () => { });
    assert(find.calledWith(commands.REPORT_TEAMSDEVICEUSAGEUSERCOUNTS));
  });
