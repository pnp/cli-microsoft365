...
describe(commands.BUCKET_ADD, () => {
  ...
  it('passes validation when valid name, planName, and ownerGroupId are specified', (done) => {
    const actual = command.validate({
      options: {
        name: 'My Planner Bucket',
        planName: 'My Planner Plan',
  ...
  it('passes validation when valid name, planName, and ownerGroupName are specified', (done) => {
    const actual = command.validate({
      options: {
        name: 'My Planner Bucket',
        planName: 'My Planner Plan',
  ...
  it('correctly adds planner bucket with name, planName, and ownerGroupName', (done) => {
    const options: any = {
      debug: false,
      name: 'My Planner Bucket',
      planName: 'My Planner Plan',
  ...
  it('correctly adds planner bucket with name, planName, and ownerGroupId', (done) => {
    const options: any = {
      debug: false,
      name: 'My Planner Bucket',
      planName: 'My Planner Plan',
