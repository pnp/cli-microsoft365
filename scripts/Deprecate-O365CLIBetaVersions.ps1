Write-Host "Deprecate beta versions of the @pnp/office365-cli npm package on npm"
$version = Read-Host "Version of the package to deprecate"
$otp = Read-Host "One-time password"
$allVersions = npm view @pnp/office365-cli versions -json | ConvertFrom-Json
...
$versionsToDeprecate | ForEach-Object {
  ...
  npm deprecate "@pnp/office365-cli@$_" "Preview version released" --otp=$otp
}