...
- Fixes [docs](../contribute/contributing-guide.mdx) contributing guide inconsistencies
- Removes deprecated onBrokenMarkdownLinks docs config
- Enforces delegated access token for onenote commands [#7049](https://github.com/pnp/cli-microsoft365/issues/7049)
- Updates [login](../cmd/login.mdx) command documentation [#3725](https://github.com/pnp/cli-microsoft365/issues/3725)
