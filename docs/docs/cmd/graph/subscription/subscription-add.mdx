...
If you want receive notifications through Azure Event Hub, the `notificationUrl` must point to your Event Hubs location.

If you want receive notifications through Azure Event Grid, the `notificationUrl` must point to your Event Grid Partner Topic.
...
Create a subscription for Event Hub location using by Key Vault
...
Create a subscription for Event Hub location using by role-based access control
