...
To archive a hub site, you first need to unregister it as a hub site.
...
- Pricing model for Microsoft 365 Archive: [https://learn.microsoft.com/en-us/microsoft-365/archive/archive-pricing](https://learn.microsoft.com/en-us/microsoft-365/archive/archive-pricing)
