...
export default [
  ...
  new FN011011_MAN_webpart_supportedHosts({ supportedHosts: true }),
  new FN012014_TSC_inlineSources({ value: false }),
  new FN012015_TSC_strictNullChecks({ value: false }),
  new FN012016_TSC_noUnusedLocals({ value: false }),
  new FN012017_TSC_extends({ path: './node_modules/@microsoft/rush-stack-compiler-2.7/includes/tsconfig-web.json' }),
