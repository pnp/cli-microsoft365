...
class SpoListAddCommand extends SpoCommand {
  ...
  Examples:
    ...
    Update list with id ${chalk.grey('3EA5A977-315E-4E25-8B0F-E4F949BF6B8F')} and set allowContentTypes ${chalk.grey('true')}
    in site ${chalk.grey('https://contoso.sharepoint.com/sites/project-x')}
      ${chalk.grey(config.delimiter)} ${commands.LIST_SET} --id '3EA5A977-315E-4E25-8B0F-E4F949BF6B8F' --allowContentTypes true --webUrl https://contoso.sharepoint.com/sites/project-x

    Update list with id ${chalk.grey('3EA5A977-315E-4E25-8B0F-E4F949BF6B8F')} and set enableVersioning ${chalk.grey('true')} and Major versions to 50
    in site ${chalk.grey('https://contoso.sharepoint.com/sites/project-x')} 
    ...
    Update list with id ${chalk.grey('3EA5A977-315E-4E25-8B0F-E4F949BF6B8F')} with content types and versioning enabled and major version limit set to ${chalk.grey('50')} and Major minor versions to ${chalk.grey('100')}
    in site ${chalk.grey('https://contoso.sharepoint.com/sites/project-x')}
  ...
  private mapRequestBody(options: Options): any {
    ...
    if (options.baseTemplate) {
      requestBody.BaseTemplate =  ListTemplateType[(options.baseTemplate.trim() as keyof typeof ListTemplateType)].valueOf();
    }
