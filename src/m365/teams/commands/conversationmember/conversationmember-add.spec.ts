...
describe(commands.TEAMS_CONVERSATIONMEMBER_ADD, () => {
  ...
  it('adds conversation members using teamId, channelId, and userId (debug)', (done) => {
  ...
  it('adds conversation members using teamId, channelId, and userDisplayName (debug)', (done) => {
    command.action(logger, {
      options: {
        debug: true,
        teamId: "47d6625d-a540-4b59-a4ab-19b787e40593",
