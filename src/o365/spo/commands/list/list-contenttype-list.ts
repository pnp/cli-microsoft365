...
class SpoListContentTypeListCommand extends SpoCommand {
  ...
  Remarks:
    ...
    To list all content types configured on a list, you have to first log in to SharePoint
    using the ${chalk.blue(commands.LOGIN)} command,
    eg. ${chalk.grey(`${config.delimiter} ${commands.LOGIN} https://contoso.sharepoint.com`)}.
        
  Examples:
  
    List all content types configured on the list with ID ${chalk.grey('0cd891ef-afce-4e55-b836-fce03286cccf')}
    ...
    List all content types configured on the list with title ${chalk.grey('Documents')} located in site
