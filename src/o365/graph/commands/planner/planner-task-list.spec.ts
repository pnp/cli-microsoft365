...
describe(commands.PLANNER_TASK_LIST, () => {
  ...
  // it('fails validation if output format is not josn|text', () => {
  //   const actual = (command.validate() as CommandValidate)({ options: { output: "asds" }  });
  //   assert.notEqual(actual, true);
  // });

  it('passes validation if output format is josn|text', () => {
