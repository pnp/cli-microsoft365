...
To remove the app from another user, use the `asAdmin` option and make sure to specify the `environmentName` option.
...
Removes the specified Power App you don't have access to
