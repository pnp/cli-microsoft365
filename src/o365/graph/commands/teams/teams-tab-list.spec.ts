...
describe(commands.TEAMS_TAB_LIST, () => {
  ...
  it('correctly lists all tabs in a Microsoft Teams channel', (done) => {
    sinon.stub(request, 'get').callsFake((opts) => {
      if (opts.url === `https://graph.microsoft.com/V1.0/teams/00000000-0000-0000-0000-000000000000/channels/19:00000000000000000000000000000000@thread.skype/tabs?$expand=teamsApp`) {
