...
- implements disambiguation prompts in missing places. [#5490](https://github.com/pnp/cli-microsoft365/issues/5490)
- adds a disambiguation prompt to getGroupIdByDisplayName. [#5592](https://github.com/pnp/cli-microsoft365/issues/5592)
