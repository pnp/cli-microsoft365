...
class SpoSiteAppPermissionRemoveCommand extends GraphCommand {
  ...
  public commandAction(logger: Logger, args: CommandArgs, cb: () => void): void {
    ...
    if (args.options.confirm) {
      ...
      Cli.prompt({
        ...
        name: 'continue',
        default: false,
        message: `Are you sure you want to remove the apppermission from a site ${args.options.siteUrl}?`
  ...
  public options(): CommandOption[] {
    const options: CommandOption[] = [
      ...
      {
        option: '-p, --permissionId [permissionId]'
      },
      {
  ...
  public validate(args: CommandArgs): boolean | string {
    ...
    if ((args.options.appId && args.options.appDisplayName) ||
      ...
      return 'Use either appId, appDisplayName, or permissionId, but not all';
    }
