...
describe(commands.TENANT_RECYCLEBINITEMS_LIST, () => {
  let vorpal: Vorpal;
  let log: any[];
  let cmdInstance: any;
  ...
  it('has correct name', () => {
    assert.equal(command.name.startsWith(commands.TENANT_RECYCLEBINITEMS_LIST), true);
  });
  ...
  it('has help referring to the right command', () => {
    ...
    cmd.help({}, () => { });
    assert(find.calledWith(commands.TENANT_RECYCLEBINITEMS_LIST));
  });
