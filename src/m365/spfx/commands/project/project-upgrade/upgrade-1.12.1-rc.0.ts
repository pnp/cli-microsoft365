...
module.exports = [
  new FN001001_DEP_microsoft_sp_core_library('1.12.1-rc.0'),
  new FN001002_DEP_microsoft_sp_lodash_subset('1.12.1-rc.0'),
  new FN001003_DEP_microsoft_sp_office_ui_fabric_core('1.12.1-rc.0'),
  new FN001004_DEP_microsoft_sp_webpart_base('1.12.1-rc.0'),
  new FN001011_DEP_microsoft_sp_dialog('1.12.1-rc.0'),
  new FN001012_DEP_microsoft_sp_application_base('1.12.1-rc.0'),
  new FN001013_DEP_microsoft_decorators('1.12.1-rc.0'),
  new FN001014_DEP_microsoft_sp_listview_extensibility('1.12.1-rc.0'),
  new FN001021_DEP_microsoft_sp_property_pane('1.12.1-rc.0'),
  new FN001023_DEP_microsoft_sp_component_base('1.12.1-rc.0'),
  new FN001024_DEP_microsoft_sp_diagnostics('1.12.1-rc.0'),
  new FN001025_DEP_microsoft_sp_dynamic_data('1.12.1-rc.0'),
  new FN001026_DEP_microsoft_sp_extension_base('1.12.1-rc.0'),
  new FN001027_DEP_microsoft_sp_http('1.12.1-rc.0'),
  new FN001028_DEP_microsoft_sp_list_subscription('1.12.1-rc.0'),
  new FN001029_DEP_microsoft_sp_loader('1.12.1-rc.0'),
  new FN001030_DEP_microsoft_sp_module_interfaces('1.12.1-rc.0'),
  new FN001031_DEP_microsoft_sp_odata_types('1.12.1-rc.0'),
  new FN001032_DEP_microsoft_sp_page_context('1.12.1-rc.0'),
  new FN002001_DEVDEP_microsoft_sp_build_web('1.12.1-rc.0'),
  new FN002002_DEVDEP_microsoft_sp_module_interfaces('1.12.1-rc.0'),
  new FN002003_DEVDEP_microsoft_sp_webpart_workbench('1.12.1-rc.0'),
  new FN002009_DEVDEP_microsoft_sp_tslint_rules('1.12.1-rc.0'),
  new FN010001_YORC_version('1.12.1-rc.0')
];