...
`--audiences [audiences]`
: (deprecated. Use option `audienceIds` instead)  Comma-separated list of Microsoft Entra group IDs that will be used as audience. Specify either `audiences`, `audienceIds` or `audienceNames`, but not multiple.

`--audienceIds [audienceIds]` 
: Comma-separated list of Microsoft Entra group IDs to be used as audiences. Specify either `audiences`, `audienceIds` or `audienceNames`, but not multiple.

`--audienceNames [audienceNames]` 
: Comma-separated list of Microsoft Entra group names to be used as audiences. You must use either `audiences`, `audienceIds` or `audienceNames`, but not multiple.
