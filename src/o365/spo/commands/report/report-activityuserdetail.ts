...
class SpoReportActivityUserDetailCommand extends DateAndPeriodBasedReport {
  ...
  Examples:
    ...
    Gets details about SharePoint activity by user for
    May 1, 2019
      ${commands.REPORT_ACTIVITYUSERDETAIL} --date 2019-05-01

    Gets details about SharePoint activity by user for the last week 
    and exports the report data in the specified path in text format
      ${commands.REPORT_ACTIVITYUSERDETAIL} --period D7 --output text --outputFile 'C:/report.txt'

    Gets details about SharePoint activity by user for the last week
    and exports the report data in the specified path in json format
      ${commands.REPORT_ACTIVITYUSERDETAIL} --period D7 --output json --outputFile 'C:/report.json'
`);
  }
}
