...
- removed `spo web rule list` and `spo web rule remove` commands and their `spo web alert` aliases following the retirement of SharePoint Alerts [#6865](https://github.com/pnp/cli-microsoft365/issues/6865)
