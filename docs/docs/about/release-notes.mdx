...
- fixed 'pa app export' without packageDisplayName [#6215](https://github.com/pnp/cli-microsoft365/issues/6215)
- added missing --force in example for 'spo app uninstall' command [#6245](https://github.com/pnp/cli-microsoft365/issues/6245)
