...
class SpoHideDefaultThemesSetCommand extends SpoCommand {
  ...
  public get description(): string {
    return 'Set the value of the HideDefaultThemes setting';
  }
  ...
  public validate(): CommandValidate {
    return (args: CommandArgs): boolean | string => {
      if (args.options.hideDefaultThemes == null) {
  ...
  Remarks:
    ...
    To set the value of the HideDefaultThemes setting, you have to first connect to a tenant admin site using the
