...
Retrieve event receiver in the specified web with given name.

```sh
m365 spo eventreceiver get --webUrl https://contoso.sharepoint.com/sites/contoso-sales --name 'PnP Test Receiver'
```

Retrieve event receiver in the specified site with given id.
...
Retrieve event receiver for list with given title in the specified web with given name.
...
Retrieve event receiver for list with given ID in the specified web with given id.
...
Retrieve event receiver for list with given url in the specified web with given name.
