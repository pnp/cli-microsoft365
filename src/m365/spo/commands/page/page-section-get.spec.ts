...
describe(commands.PAGE_SECTION_GET, () => {
  ...
  it('lists sections on the modern page', (done) => {
    ...
    command.action(logger, { options: { debug: false, webUrl: 'https://contoso.sharepoint.com/sites/team-a', pageName: 'home.aspx', section: 1 } }, () => {
      try {
  ...
  it('lists sections on the modern page (debug)', (done) => {
    ...
    command.action(logger, { options: { debug: true, webUrl: 'https://contoso.sharepoint.com/sites/team-a', pageName: 'home.aspx', section: 1 } }, () => {
      try {
        assert(loggerLogSpy.calledWith({
          "order": 1,
          "columns": [
  ...
  it('lists sections on the modern page when the specified page name doesn\'t contain extension', (done) => {
    ...
    command.action(logger, { options: { debug: false, webUrl: 'https://contoso.sharepoint.com/sites/team-a', pageName: 'home', section: 1 } }, () => {
      try {
        assert(loggerLogSpy.calledWith({
          "order": 1,
          "columns": [
  ...
  it('lists all information about sections on the modern page in json output mode', (done) => {
    ...
    command.action(logger, { options: { debug: false, webUrl: 'https://contoso.sharepoint.com/sites/team-a', pageName: 'home.aspx', output: 'json', section: 1 } }, () => {
      try {
  ...
  it('shows error when the specified page is a classic page', (done) => {
    ...
    command.action(logger, { options: { debug: false, webUrl: 'https://contoso.sharepoint.com/sites/team-a', pageName: 'home.aspx', sectipn: 1 } } as any, (err?: any) => {
      try {
  ...
  it('correctly handles page not found', (done) => {
    ...
    command.action(logger, { options: { debug: false, webUrl: 'https://contoso.sharepoint.com/sites/team-a', pageName: 'home.aspx', section: 1 } } as any, (err?: any) => {
      try {
