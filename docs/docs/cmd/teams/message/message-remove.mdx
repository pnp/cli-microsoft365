...
You can only remove a message from a Microsoft Teams team that you posted yourself. If you try to remove a message that was posted by someone else, the command will fail.

:::warning

This command does not support application only permissions.
