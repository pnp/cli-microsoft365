...
describe(commands.YAMMER_REPORT_DEVICEUSERDETAIL, () => {
  let vorpal: Vorpal;
  let log: string[];
  let cmdInstance: any;
  ...
  it('has correct name', () => {
    assert.equal(command.name.startsWith(commands.YAMMER_REPORT_DEVICEUSERDETAIL), true);
  });
  ...
  it('has help referring to the right command', () => {
    ...
    cmd.help({}, () => { });
    assert(find.calledWith(commands.YAMMER_REPORT_DEVICEUSERDETAIL));
  });
});
