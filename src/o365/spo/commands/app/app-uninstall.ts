...
class AppUninstallCommand extends SpoCommand {
  ...
  Examples:
    ...
    Uninstall the app with ID ${chalk.grey('b2307a39-e878-458b-bc90-03bc578531d6')}
    from the ${chalk.grey('https://contoso.sharepoint.com')} site where the app is deployed to the site collection app catalog of ${chalk.grey('https://contoso.sharepoint.com')}.
