...
: (deprecated. Use `entraGroupId` instead) The object Id of the Microsoft Entra ID group to remove as a member. Specify either `userName`, `email`, `userId`, `aadGroupId`, `entraGroupId`, `aadGroupName`, or `entraGroupName`.
...
: (deprecated. Use `entraGroupName` instead) The name of the Microsoft Entra ID group to remove as a member. Specify either `userName`, `email`, `userId`, `aadGroupId`, `entraGroupId`, `aadGroupName`, or `entraGroupName`.
```
