...
describe('utils/spp', () => {
  ...
  it('retrieves model by title', async () => {
    ...
    await spp.getModel('https://contoso.sharepoint.com/sites/portal', 'ModelName');
    assert(stubGet.calledOnce);
  });
  ...
  it('retrieves model by title with classifier suffix', async () => {
    ...
    await spp.getModel('https://contoso.sharepoint.com/sites/portal', 'ModelName.classifier');
    assert(stubGet.calledOnce);
  });
  ...
  it('correctly handles a model is not found error by title', async () => {
    ...
    await assert.rejects(spp.getModel('https://contoso.sharepoint.com/sites/portal', 'invalidTitle'),
