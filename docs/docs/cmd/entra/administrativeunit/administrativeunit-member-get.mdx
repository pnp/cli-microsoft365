...
```sh
m365 entra administrativeunit member get --id 64131a70-beb9-4ccb-b590-4401e58446ec --administrativeUnitId fc33aa61-cf0e-46b6-9506-f633347202ab 
```

Get information about a member specified by id from an administrative unit specified by name

```sh
m365 entra administrativeunit member get --id 64131a70-beb9-4ccb-b590-4401e58446ec --administrativeUnitName 'European Division' 
```
