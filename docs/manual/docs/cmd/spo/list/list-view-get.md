...
Gets a list view located in site _https://contoso.sharepoint.com/sites/project-x_ by its name

```sh
 spo list view get --webUrl https://contoso.sharepoint.com/sites/project-x --listTitle 'My List' --viewTitle 'All Items'
```

Gets a list view located in site _https://contoso.sharepoint.com/sites/project-x_ by its ID
...
Gets a list view located in site _https://contoso.sharepoint.com/sites/project-x_ by its name, but using ID with the listId option
