...
import GraphCommand from "../../../base/graph/GraphCommand";
import { Team } from '../../../base/teams/Team';
...
class TeamsGuestSettingsListCommand extends GraphCommand {
  ...
  public commandHelp(args: CommandArgs, log: (help: string) => void): void {
    ...
    Get guest settings for a Microsoft Teams team
      ${commands.TEAMS_GUESTSETTINGS_LIST} --teamId 2609af39-7775-4f94-a3dc-0dd67657e900
`);
  }
}
