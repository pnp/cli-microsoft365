...
: Keeps not specified properties.
```
...
If a property of the open extesion is not specified, the property is removed from the open extension.

If a property of the open extesion is not specified and `keepUnchangedProperties` is specified, the property will be kept in the open extension.
