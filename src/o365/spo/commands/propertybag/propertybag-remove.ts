...
class SpoPropertyBagRemoveCommand extends SpoPropertyBagBaseCommand {
  ...
  Examples:
    ...
    Removes the value of the _key1_ property from the property bag located in site ${chalk.grey('https://contoso.sharepoint.com/sites/test')}
      ${chalk.grey(config.delimiter)} ${commands.PROPERTYBAG_REMOVE} --webUrl https://contoso.sharepoint.com/sites/test --key key1

    Removes the value of the _key1_ property from the property bag located in site root folder ${chalk.grey('https://contoso.sharepoint.com/sites/test')}
      ${chalk.grey(config.delimiter)} ${commands.PROPERTYBAG_REMOVE} -u https://contoso.sharepoint.com/sites/test -k key1 -f / --confirm

    Removes the value of the _key1_ property from the property bag located in site document library ${chalk.grey('https://contoso.sharepoint.com/sites/test')}
    ...
    Removes property bag value located in folder in site document library ${chalk.grey('https://contoso.sharepoint.com/sites/test')}
      ${chalk.grey(config.delimiter)} ${commands.PROPERTYBAG_REMOVE} -u https://contoso.sharepoint.com/sites/test -k key1 -f '/Shared Documents/MyFolder'

    Removes the value of the _key1_ property from the property bag located in site list ${chalk.grey('https://contoso.sharepoint.com/sites/test')}
