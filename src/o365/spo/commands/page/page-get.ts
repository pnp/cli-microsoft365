    ...
    auth
      ...
      .then((accessToken: string): request.RequestPromise => {
        ...
        const requestOptions: any = {
          url: `${args.options.webUrl}/_api/web/getfilebyserverrelativeurl('${args.options.webUrl.substr(args.options.webUrl.indexOf('/', 8))}/SitePages/${encodeURIComponent(pageName)}')?$expand=ListItemAllFields/ClientSideApplicationId,ListItemAllFields/_ModerationStatus,ListItemAllFields/FileLeafRef,ListItemAllFields/PageLayoutType,ListItemAllFields/CommentsDisabled`,
