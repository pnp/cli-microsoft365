...
class SpoAppTeamsPackageDownloadCommand extends SpoAppBaseCommand {
  ...
  private ensureAppInfo(logger: Logger, args: CommandArgs, appInfo: AppInfo): Promise<void> {
    ...
    return this
      ...
      .then(_ => {
        ...
        const serverRelativeAppCatalogListUrl = `${Utils.getServerRelativeSiteUrl(this.appCatalogUrl as string)}/${appCatalogListName}`;
  ...
  public validate(args: CommandArgs): boolean | string {
    ...
    if (args.options.appItemUniqueId &&
      !Utils.isValidGuid(args.options.appItemUniqueId)) {
