...
describe(commands.APP_RETRACT, () => {
  ...
  it('retracts app from the specified site collection app catalog', (done) => {
    ...
    command.action(logger, { options: { debug: true, id: 'b2307a39-e878-458b-bc90-03bc578531d6', appCatalogUrl: 'https://contoso.sharepoint.com/sites/site1', appCatalogScope: 'sitecollection', confirm: true } }, () => {
      let correctRequestIssued = false;
      requests.forEach(r => {
