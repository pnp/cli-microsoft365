...
const appDeployCommand: Command = require('./app-deploy');
...
describe(commands.APP_DEPLOY, () => {
  ...
  it('has correct name', () => {
    assert.equal(appDeployCommand.name.startsWith(commands.APP_DEPLOY), true);
  });

  it('has a description', () => {
    assert.notEqual(appDeployCommand.description, null);
  });

  it('calls telemetry', (done) => {
    cmdInstance.action = appDeployCommand.action();
  ...
  it('supports verbose mode', () => {
    const options = (appDeployCommand.options() as CommandOption[]);
  ...
  it('has help referring to the right command', () => {
    ...
    (appDeployCommand.help() as CommandHelp)({}, helpLog);
  ...
  it('has help with examples', () => {
    ...
    (appDeployCommand.help() as CommandHelp)({}, log);
