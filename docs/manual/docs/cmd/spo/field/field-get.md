...
Retrieves information about the specified list field or site column
...
To retrieve information about a field, you have to first log in to a SharePoint Online site using the [spo login](../login.md) command, eg. `spo login https://contoso.sharepoint.com`.
...
Retrieves list field by id located in site _https://contoso.sharepoint.com/sites/contoso-sales_. Retrieves the list by its title
...
Retrieves list field by display name located in site _https://contoso.sharepoint.com/sites/contoso-sales_. Retrieves the list by its url
