...
Adds multiple members (subgroups) specified by name as owners to a group specified by ID.

```sh
m365 entra group member add --groupId a03c0c35-ef9a-419b-8cab-f89e0a8d2d2a --subgroupNames "john.doe@contoso.com,adele.vance@contoso.com" --role Owner
```
