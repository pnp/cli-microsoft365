...
Using the `spfx project upgrade` command you can also upgrade your project to the latest preview version of the SharePoint Framework (v1.12.1-rc.2). To upgrade project to this preview version, either use the `--preview` option or specify the preview version using the `--toVersion` option, eg. `--toVersion 1.12.1-rc.2`.
