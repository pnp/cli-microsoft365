...
const appAddCommand: Command = require('./app-add');
...
describe(commands.APP_ADD, () => {
  ...
  it('has correct name', () => {
    assert.equal(appAddCommand.name.startsWith(commands.APP_ADD), true);
  });

  it('has a description', () => {
    assert.notEqual(appAddCommand.description, null);
  });

  it('calls telemetry', (done) => {
    cmdInstance.action = appAddCommand.action();
  ...
  it('supports verbose mode', () => {
    const options = (appAddCommand.options() as CommandOption[]);
  ...
  it('has help referring to the right command', () => {
    ...
    (appAddCommand.help() as CommandHelp)({}, helpLog);
  ...
  it('has help with examples', () => {
    ...
    (appAddCommand.help() as CommandHelp)({}, log);
