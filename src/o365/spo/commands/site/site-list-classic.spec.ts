...
describe(commands.SITE_LIST_CLASSIC, () => {
  ...
  it('accepts STS#0 site type', () => {
    const actual = (command.validate() as CommandValidate)({ options: { type: 'STS#0' } });
    assert.equal(actual, true);
  });

  it('accepts BLOG#0 site type', () => {
    const actual = (command.validate() as CommandValidate)({ options: { type: 'BLOG#0' } });
    assert.equal(actual, true);
  });
  
  it('accepts BDR#0 site type', () => {
    const actual = (command.validate() as CommandValidate)({ options: { type: 'BDR#0' } });
    assert.equal(actual, true);
  });
  
  it('accepts DEV#0 site type', () => {
    const actual = (command.validate() as CommandValidate)({ options: { type: 'DEV#0' } });
    assert.equal(actual, true);
  });
  
  it('accepts OFFILE#1 site type', () => {
    const actual = (command.validate() as CommandValidate)({ options: { type: 'OFFILE#1' } });
    assert.equal(actual, true);
  });
  
  it('accepts EHS#1 site type', () => {
    const actual = (command.validate() as CommandValidate)({ options: { type: 'EHS#1' } });
    assert.equal(actual, true);
  });
  
  it('accepts BICenterSite#0 site type', () => {
    const actual = (command.validate() as CommandValidate)({ options: { type: 'BICenterSite#0' } });
    assert.equal(actual, true);
  });
  
  it('accepts SRCHCEN#0 site type', () => {
    const actual = (command.validate() as CommandValidate)({ options: { type: 'SRCHCEN#0' } });
    assert.equal(actual, true);
  });

  it('accepts BLANKINTERNET#0 site type', () => {
    const actual = (command.validate() as CommandValidate)({ options: { type: 'BLANKINTERNET#0' } });
    assert.equal(actual, true);
  });
  
  it('accepts BLANKINTERNETCONTAINER#0 site type', () => {
    const actual = (command.validate() as CommandValidate)({ options: { type: 'BLANKINTERNETCONTAINER#0' } });
    assert.equal(actual, true);
  });
  
  it('accepts ENTERWIKI#0 site type', () => {
    const actual = (command.validate() as CommandValidate)({ options: { type: 'ENTERWIKI#0' } });
    assert.equal(actual, true);
  });
  
  it('accepts PROJECTSITE#0 site type', () => {
    const actual = (command.validate() as CommandValidate)({ options: { type: 'PROJECTSITE#0' } });
    assert.equal(actual, true);
  });
  
  it('accepts PRODUCTCATALOG#0 site type', () => {
    const actual = (command.validate() as CommandValidate)({ options: { type: 'PRODUCTCATALOG#0' } });
    assert.equal(actual, true);
  });
  
  it('accepts COMMUNITY#0 site type', () => {
    const actual = (command.validate() as CommandValidate)({ options: { type: 'COMMUNITY#0' } });
    assert.equal(actual, true);
  });
  
  it('accepts COMMUNITYPORTAL#0 site type', () => {
    const actual = (command.validate() as CommandValidate)({ options: { type: 'COMMUNITYPORTAL#0' } });
    assert.equal(actual, true);
  });
  
  it('accepts SRCHCENTERLITE#0 site type', () => {
    const actual = (command.validate() as CommandValidate)({ options: { type: 'SRCHCENTERLITE#0' } });
    assert.equal(actual, true);
  });
  
  it('accepts visprus#0 site type', () => {
    const actual = (command.validate() as CommandValidate)({ options: { type: 'visprus#0' } });
    assert.equal(actual, true);
  });

  it('accepts GROUP#0 site type', () => {
    const actual = (command.validate() as CommandValidate)({ options: { type: 'GROUP#0' } });
    assert.equal(actual, true);
  });

  it('accepts SITEPAGEPUBLISHING#0 site type', () => {
    const actual = (command.validate() as CommandValidate)({ options: { type: 'SITEPAGEPUBLISHING#0' } });
    assert.equal(actual, true);
  });
