...
class SpoPropertyBagListCommand extends SpoPropertyBagBaseCommand {
  ...
  Remarks:
    ...
    To retrieve property bag values, you have to first connect to a SharePoint Online site using the
    ${chalk.blue(commands.CONNECT)} command, eg. ${chalk.grey(`${config.delimiter} ${commands.CONNECT} https://contoso.sharepoint.com`)}.

  Examples:
    Return propery bag values located in site ${chalk.grey('https://contoso.sharepoint.com/sites/test')}
      ${chalk.grey(config.delimiter)} ${commands.PROPERTYBAG_LIST} -w https://contoso.sharepoint.com/sites/test

    Return propery bag values located in site root folder ${chalk.grey('https://contoso.sharepoint.com/sites/test')}
      ${chalk.grey(config.delimiter)} ${commands.PROPERTYBAG_LIST} -w https://contoso.sharepoint.com/sites/test -f /

    Return propery bag values located in site document library ${chalk.grey('https://contoso.sharepoint.com/sites/test')}
    ...
    Return propery bag values located in folder in site document library ${chalk.grey('https://contoso.sharepoint.com/sites/test')}
    ...
    Return propery bag values located in site list ${chalk.grey('https://contoso.sharepoint.com/sites/test')}
