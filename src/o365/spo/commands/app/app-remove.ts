...
class AppRemoveCommand extends SpoCommand {
  ...
  public get description(): string {
    return 'Removes an app from the tenant app catalog';
  }
  ...
  public commandAction(cmd: CommandInstance, args: CommandArgs, cb: () => void): void {
    ...
    auth
      ...
      .then((res: string): Promise<string> => {
        ...
        cmd.log(`Removing app...`);

        const requestOptions: any = {
          url: `${appCatalogUrl}/_api/web/tenantappcatalog/AvailableApps/GetByID('${args.options.identity}')/remove`,
          headers: {
            authorization: `Bearer ${auth.service.accessToken}`,
    ...
    const options: CommandOption[] = [
      {
        ...
        description: 'The id of the app to remove. Needs to be available in the app catalog.'
      }
    ];
  ...
  Examples:
    ...
    ${chalk.grey(config.delimiter)} ${commands.APP_DEPLOY} --identity 058140e3-0e37-44fc-a1d3-79c487d371a3
      Remove a given app from the app catalog
