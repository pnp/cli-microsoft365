...
Lists API permissions for the current Microsoft Entra ID app
...
```md definition-list
`--appId [appId]`
: Client ID of the Microsoft Entra ID app registered in the .m365rc.json file to retrieve API permissions for.
```
...
Use this command to quickly look up API permissions for the Microsoft Entra ID application registration registered in the _.m365rc.json_ file in your current project (folder).
...
Retrieve API permissions for your current Microsoft Entra ID app.

```sh
m365 app permission list
```

Retrieve API permissions for the Microsoft Entra ID app with the client ID specified in the _.m365rc.json_ file.
