...
class SpoFieldRemoveCommand extends SpoCommand {
  ...
  public commandAction(cmd: CommandInstance, args: CommandArgs, cb: () => void): void {
    ...
    if (args.options.listId || args.options.listTitle) {
      messageEnd = `from list ${args.options.listId || args.options.listTitle}`;
    }
    else {
    ...
    if (args.options.confirm) {
      ...
      const confirmMessage: string = `Are you sure you want to remove the ${args.options.group ? 'fields' : 'field'} ${args.options.id || args.options.fieldTitle || ' belonging to the group '  + args.options.group} ${messageEnd}?`;
  ...
  public options(): CommandOption[] {
    const options: CommandOption[] = [
      ...
      {
        option: '-i, --id [id]',
        description: 'The ID of the field to remove. Specify id, fieldTitle, or group individually'
      },
      {
        option: '-t, --fieldTitle [fieldTitle]',
        description: 'The display name (case-sensitive) of the field to remove. Specify id, fieldTitle, or group individually'
      },
      {
        option: '-g, --group [group]',
        description: 'Delete all fields assigned to the group (case-sensitive). Specify id, fieldTitle, or group individually'
      },
      {
        option: '--confirm',
  ...
  Examples:
    ...
    Remove all site columns associated to the group "MyGroup"
