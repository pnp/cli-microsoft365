...
```sh
m365 spo homesite set --url https://contoso.sharepoint.com/sites/comms
```
...
```sh
m365 spo homesite set --url https://contoso.sharepoint.com/sites/comms --vivaConnectionsDefaultStart false
```
