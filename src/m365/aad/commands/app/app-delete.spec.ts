...
describe(commands.APP_DELETE, () => {
  ...
  it('fails when multiple apps with same name exists', (done) => {
    ...
    sinon.stub(request, 'get').callsFake((opts) => {
      ...
      return Promise.reject("Multiple Azure AD application registration with name myapp found. Please disambiguate using app object IDs: d75be2e1-0204-4f95-857d-51a37cf40be8, 340a4aa3-1af6-43ac-87d8-189819003952");
    });
    ...
    command.action(logger, {
      ...
      try {
        assert.strictEqual(JSON.stringify(err), JSON.stringify(new CommandError("Multiple Azure AD application registration with name myapp found. Please disambiguate using app object IDs: d75be2e1-0204-4f95-857d-51a37cf40be8, 340a4aa3-1af6-43ac-87d8-189819003952")));
        done();
      }
      catch (e) {
        done(e);
