...
<Tabs>
  ...
  ```md
  # spo homesite set --debug "false" --verbose "false" --siteUrl "https://contoso.sharepoint.com/sites/TheLanding" --vivaConnectionsDefaultStart "true" --audienceNames "active"
