...
`--owner <owner>`
: The Id ID the Microsoft Entra ID application that is the owner of the schema extension
...
The schema extension owner is the ID of the Microsoft Entra ID application that is the owner of the schema extension. Once set, this property is read-only and cannot be changed.
