...
- added minimal permissions for 'entra app permission add', 'entra app permission list', 'entra app permission remove' [#6924](https://github.com/pnp/cli-microsoft365/issues/6924)
- added support for HTML messages using teams chat message send [#6483](https://github.com/pnp/cli-microsoft365/pull/6483)
- enhanced 'teams chat message list' command [#6484](https://github.com/pnp/cli-microsoft365/pull/6484)
