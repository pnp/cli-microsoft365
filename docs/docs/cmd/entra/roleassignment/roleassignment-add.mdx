...
Assign a Entra ID role to either a user, a group, or a service principal and specify the scope for which the principal has been granted access
...
<Tabs>
  ...
  ```md
  # entra roleassignment add --debug "false" --verbose "false" --roleDefinitionId "92b086b3-e367-4ef2-b869-1de128fb986e" --principal "3844129d-f748-4c03-8165-4412ee9b4ceb"
