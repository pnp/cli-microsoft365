...
<Tabs>
  ...
  ```csv
  @odata.context,directoryPropertyName,displayName,displayName-nl-NL
https://graph.microsoft.com/v1.0/$metadata#admin/people/profileCardProperties/$entity,customAttribute1,Cost center,Kostenplaats
  ```
