...
`--planId [planId]`
: ID of the plan to update the bucket of. Specify either `planId` or `planName` but not both.

`--planName [planName]`
: Name of the plan to update the bucket of. Specify either `planId` or `planName` but not both.
